...
int main(int argc, char *argv[]) {
  ...
  3b:	56                   	push   %esi
  3c:	53                   	push   %ebx
  3d:	e8 11 03 00 00       	call   353 <setlevel>
    // for(i = 0; i < 3; i++) {
    //     kill(pids[i]);
    //     wait();
    // }
 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 ec 07 00 00 	movzbl 0x7ec(%edx),%edx
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 94 07 00 00 	jmp    *0x794(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 8c 07 00 00       	mov    $0x78c,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 9c 0a 00 00    	mov    0xa9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d 9c 0a 00 00    	mov    0xa9c,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 9c 0a 00 00    	mov    0xa9c,%edx
 ...
 6fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
}
 ...
 70f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 9c 0a 00 00 a0 	movl   $0xaa0,0xa9c
 717:	0a 00 00 
    base.s.size = 0;
 71a:	bf a0 0a 00 00       	mov    $0xaa0,%edi
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 a0 0a 00 00 a0 	movl   $0xaa0,0xaa0
 726:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 a4 0a 00 00 00 	movl   $0x0,0xaa4
 732:	00 00 00 
    if(p->s.size >= nunits){
