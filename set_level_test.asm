...
int main(int argc, char *argv[]) {
  ...
  19:	74 05                	je     20 <main+0x20>
        exit();
  1b:	e8 a3 02 00 00       	call   2c3 <exit>
    }
    int target_pid = atoi(argv[1]);
  20:	83 ec 0c             	sub    $0xc,%esp
  23:	ff 73 04             	push   0x4(%ebx)
  26:	e8 25 02 00 00       	call   250 <atoi>
  ...
  48:	53                   	push   %ebx
  49:	56                   	push   %esi
  4a:	e8 14 03 00 00       	call   363 <setlevel>
    printprocinfo();
  4f:	e8 17 03 00 00       	call   36b <printprocinfo>
    printf(1, "Test program finished.\n");
  54:	59                   	pop    %ecx
  55:	5b                   	pop    %ebx
  56:	68 84 07 00 00       	push   $0x784
  5b:	6a 01                	push   $0x1
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 a4 07 00 00 	jmp    *0x7a4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 9c 07 00 00       	mov    $0x79c,%edx
        while(*s != 0){
 ...
 5d1:	a1 ac 0a 00 00       	mov    0xaac,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 ac 0a 00 00    	mov    %edx,0xaac
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 ac 0a 00 00    	mov    %edx,0xaac
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d ac 0a 00 00    	mov    0xaac,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d ac 0a 00 00    	mov    0xaac,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
 ...
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf b0 0a 00 00       	mov    $0xab0,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 b4 0a 00 00 00 	movl   $0x0,0xab4
 742:	00 00 00 
    if(p->s.size >= nunits){
