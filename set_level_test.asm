...
_set_level_test:     file format elf32-i386
...
int main(int argc, char *argv[]) {
   ...
   d:	57                   	push   %edi
   e:	56                   	push   %esi
   f:	8d 7d e8             	lea    -0x18(%ebp),%edi
  12:	53                   	push   %ebx
  13:	8d 5d dc             	lea    -0x24(%ebp),%ebx
  16:	51                   	push   %ecx
  17:	83 ec 34             	sub    $0x34,%esp
  1a:	8b 71 04             	mov    0x4(%ecx),%esi
    int pids[3];
    int i;

    int target_pid = atoi(argv[1]);
  1d:	ff 76 04             	push   0x4(%esi)
  20:	e8 7b 02 00 00       	call   2a0 <atoi>
  25:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    int queue = atoi(argv[2]);
  28:	58                   	pop    %eax
  29:	ff 76 08             	push   0x8(%esi)
  2c:	e8 6f 02 00 00       	call   2a0 <atoi>
  ...
  41:	83 c4 10             	add    $0x10,%esp
        int pid = fork();
  44:	e8 c2 02 00 00       	call   30b <fork>
        if(pid < 0) {
  49:	85 c0                	test   %eax,%eax
  4b:	78 5f                	js     ac <main+0xac>
            printf(2, "fork failed\n");
            exit();
        }
        if(pid == 0) {
  4d:	74 5b                	je     aa <main+0xaa>
            }
        ...
        pids[i] = pid;
  4f:	89 03                	mov    %eax,(%ebx)
    for(i = 0; i < 3; i++) {
  51:	83 c3 04             	add    $0x4,%ebx
  54:	39 df                	cmp    %ebx,%edi
  56:	75 ec                	jne    44 <main+0x44>
    }
  ...
  5b:	6a 0a                	push   $0xa
  5d:	e8 41 03 00 00       	call   3a3 <sleep>
  ...
  63:	5a                   	pop    %edx
  64:	56                   	push   %esi
  65:	ff 75 d4             	push   -0x2c(%ebp)
  68:	e8 46 03 00 00       	call   3b3 <setlevel>
    ...
    for(i = 0; i < 3; i++) {
        kill(pids[i]);
  6d:	59                   	pop    %ecx
  6e:	ff 75 dc             	push   -0x24(%ebp)
  71:	e8 cd 02 00 00       	call   343 <kill>
        wait();
  76:	e8 a0 02 00 00       	call   31b <wait>
        kill(pids[i]);
  7b:	5b                   	pop    %ebx
  7c:	ff 75 e0             	push   -0x20(%ebp)
  7f:	e8 bf 02 00 00       	call   343 <kill>
        wait();
  84:	e8 92 02 00 00       	call   31b <wait>
        kill(pids[i]);
  89:	5e                   	pop    %esi
  8a:	ff 75 e4             	push   -0x1c(%ebp)
  8d:	e8 b1 02 00 00       	call   343 <kill>
        wait();
  92:	e8 84 02 00 00       	call   31b <wait>
    }

    printf(1, "Test program finished.\n");
  97:	5f                   	pop    %edi
  98:	58                   	pop    %eax
  99:	68 e1 07 00 00       	push   $0x7e1
  9e:	6a 01                	push   $0x1
  a0:	e8 db 03 00 00       	call   480 <printf>
    exit();
  a5:	e8 69 02 00 00       	call   313 <exit>
            while(1) {
  aa:	eb fe                	jmp    aa <main+0xaa>
            printf(2, "fork failed\n");
  ac:	50                   	push   %eax
  ad:	50                   	push   %eax
  ae:	68 d4 07 00 00       	push   $0x7d4
  b3:	6a 02                	push   $0x2
...
000003bb <printprocinfo>:
SYSCALL(printprocinfo)
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 00 08 00 00 	jmp    *0x800(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba f9 07 00 00       	mov    $0x7f9,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 10 0b 00 00       	mov    0xb10,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 10 0b 00 00    	mov    %edx,0xb10
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 10 0b 00 00    	mov    %edx,0xb10
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 10 0b 00 00    	mov    0xb10,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 10 0b 00 00    	mov    0xb10,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 10 0b 00 00    	mov    0xb10,%edx
 ...
 75c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 75f:	89 15 10 0b 00 00    	mov    %edx,0xb10
}
 ...
 76f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 10 0b 00 00 14 	movl   $0xb14,0xb10
 777:	0b 00 00 
    base.s.size = 0;
 77a:	bf 14 0b 00 00       	mov    $0xb14,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 14 0b 00 00 14 	movl   $0xb14,0xb14
 786:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 18 0b 00 00 00 	movl   $0x0,0xb18
 792:	00 00 00 
    if(p->s.size >= nunits){
