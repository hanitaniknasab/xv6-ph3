...
int main(int argc, char *argv[]) {
  ...
  48:	53                   	push   %ebx
  49:	56                   	push   %esi
  4a:	e8 24 03 00 00       	call   373 <dl_proc>
  4f:	83 c4 10             	add    $0x10,%esp
  52:	83 c0 01             	add    $0x1,%eax
  55:	74 c4                	je     1b <main+0x1b>
        exit();
    }
    printprocinfo();
  57:	e8 0f 03 00 00       	call   36b <printprocinfo>
    printf(1, "Test program finished.\n");
  5c:	50                   	push   %eax
  5d:	50                   	push   %eax
  5e:	68 7f 07 00 00       	push   $0x77f
  63:	6a 01                	push   $0x1
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 f8 07 00 00 	movzbl 0x7f8(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 a0 07 00 00 	jmp    *0x7a0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 97 07 00 00       	mov    $0x797,%edx
        while(*s != 0){
