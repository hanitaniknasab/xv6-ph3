...
801003a2:	68 4d 7d 10 80       	push   $0x80107d4d
...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 2c 83 10 80 	movl   $0x8010832c,(%esp)
...
801003d5:	83 c3 04             	add    $0x4,%ebx
    cprintf(" %p", pcs[i]);
801003d8:	68 61 7d 10 80       	push   $0x80107d61
...
8010041a:	e8 21 64 00 00       	call   80106840 <uartputc>
...
80100505:	e8 36 63 00 00       	call   80106840 <uartputc>
8010050a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100511:	e8 2a 63 00 00       	call   80106840 <uartputc>
80100516:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010051d:	e8 1e 63 00 00       	call   80106840 <uartputc>
...
80100579:	68 65 7d 10 80       	push   $0x80107d65
...
80100636:	0f b6 92 90 7d 10 80 	movzbl -0x7fef8270(%edx),%edx
  }while((x /= base) != 0);
...
80100837:	90                   	nop
        s = "(null)";
80100838:	bf 78 7d 10 80       	mov    $0x80107d78,%edi
      for(; *s; s++)
...
80100873:	68 7f 7d 10 80       	push   $0x80107d7f
...
80100a66:	68 88 7d 10 80       	push   $0x80107d88
...
80100b32:	75 d2                	jne    80100b06 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100b34:	e8 97 6e 00 00       	call   801079d0 <setupkvm>
...
80100ba3:	e8 48 6c 00 00       	call   801077f0 <allocuvm>
...
80100bd9:	e8 22 6b 00 00       	call   80107700 <loaduvm>
...
80100c1b:	e8 30 6d 00 00       	call   80107950 <freevm>
  if(ip){
...
80100c62:	e8 89 6b 00 00       	call   801077f0 <allocuvm>
...
80100c81:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c83:	e8 e8 6d 00 00       	call   80107a70 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cf8:	e8 43 6f 00 00       	call   80107c40 <copyout>
...
80100d11:	e8 3a 6c 00 00       	call   80107950 <freevm>
...
80100d5f:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d65:	e8 d6 6e 00 00       	call   80107c40 <copyout>
...
80100d9f:	e8 ec 45 00 00       	call   80105390 <safestrcpy>
...
80100dd5:	e8 96 67 00 00       	call   80107570 <switchuvm>
  freevm(oldpgdir);
80100dda:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100de0:	89 04 24             	mov    %eax,(%esp)
80100de3:	e8 68 6b 00 00       	call   80107950 <freevm>
...
80100ded:	68 ad 7d 10 80       	push   $0x80107dad
80100df2:	53                   	push   %ebx
80100df3:	e8 e8 44 00 00       	call   801052e0 <strncmp>
...
80100e0b:	68 b0 7d 10 80       	push   $0x80107db0
80100e10:	53                   	push   %ebx
80100e11:	e8 ca 44 00 00       	call   801052e0 <strncmp>
...
80100e48:	68 a1 7d 10 80       	push   $0x80107da1
...
80100e76:	68 b5 7d 10 80       	push   $0x80107db5
80100e7b:	68 60 ff 10 80       	push   $0x8010ff60
80100e80:	e8 bb 40 00 00       	call   80104f40 <initlock>
}
...
80100ea1:	e8 6a 42 00 00       	call   80105110 <acquire>
...
80100ed1:	e8 da 41 00 00       	call   801050b0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100eea:	e8 c1 41 00 00       	call   801050b0 <release>
}
...
80100f0f:	e8 fc 41 00 00       	call   80105110 <acquire>
  if(f->ref < 1)
...
80100f2c:	e8 7f 41 00 00       	call   801050b0 <release>
  return f;
}
...
80100f3b:	68 bc 7d 10 80       	push   $0x80107dbc
...
80100f61:	e8 aa 41 00 00       	call   80105110 <acquire>
  if(f->ref < 1)
...
80100f99:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f9c:	e8 0f 41 00 00       	call   801050b0 <release>
...
80100fcd:	5d                   	pop    %ebp
    release(&ftable.lock);
80100fce:	e9 dd 40 00 00       	jmp    801050b0 <release>
...
8010101c:	68 c4 7d 10 80       	push   $0x80107dc4
...
80101102:	68 ce 7d 10 80       	push   $0x80107dce
...
801011d7:	68 d7 7d 10 80       	push   $0x80107dd7
...
80101211:	68 dd 7d 10 80       	push   $0x80107ddd
...
80101287:	68 e7 7d 10 80       	push   $0x80107de7
...
80101344:	68 fa 7d 10 80       	push   $0x80107dfa
...
80101385:	e8 46 3e 00 00       	call   801051d0 <memset>
  log_write(bp);
...
801013ca:	e8 41 3d 00 00       	call   80105110 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80101437:	e8 74 3c 00 00       	call   801050b0 <release>
...
80101462:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101465:	e8 46 3c 00 00       	call   801050b0 <release>
      return ip;
...
80101498:	68 10 7e 10 80       	push   $0x80107e10
...
80101575:	68 20 7e 10 80       	push   $0x80107e20
...
801015a1:	e8 ca 3c 00 00       	call   80105270 <memmove>
  brelse(bp);
...
8010161c:	e8 4f 3c 00 00       	call   80105270 <memmove>
  brelse(bp);
...
80101653:	68 a0 7e 10 80       	push   $0x80107ea0
...
801016ee:	e8 dd 3a 00 00       	call   801051d0 <memset>
      dip->type = type;
...
80101723:	68 40 7e 10 80       	push   $0x80107e40
...
80101791:	e8 da 3a 00 00       	call   80105270 <memmove>
  log_write(bp);
...
801017bf:	e8 4c 39 00 00       	call   80105110 <acquire>
  ip->ref++;
801017c4:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
801017c8:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
801017cf:	e8 dc 38 00 00       	call   801050b0 <release>
}
...
80101802:	e8 49 36 00 00       	call   80104e50 <acquiresleep>
  if(ip->valid == 0){
...
80101878:	e8 f3 39 00 00       	call   80105270 <memmove>
    brelse(bp);
...
8010189d:	68 58 7e 10 80       	push   $0x80107e58
801018a2:	e8 d9 ea ff ff       	call   80100380 <panic>
    panic("ilock");
801018a7:	83 ec 0c             	sub    $0xc,%esp
801018aa:	68 52 7e 10 80       	push   $0x80107e52
...
801018d3:	e8 18 36 00 00       	call   80104ef0 <holdingsleep>
...
801018ee:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801018ef:	e9 bc 35 00 00       	jmp    80104eb0 <releasesleep>
    panic("iunlock");
801018f4:	83 ec 0c             	sub    $0xc,%esp
801018f7:	68 67 7e 10 80       	push   $0x80107e67
...
80101920:	e8 2b 35 00 00       	call   80104e50 <acquiresleep>
...
8010193a:	e8 71 35 00 00       	call   80104eb0 <releasesleep>
  acquire(&icache.lock);
8010193f:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
80101946:	e8 c5 37 00 00       	call   80105110 <acquire>
  ip->ref--;
...
80101a83:	e8 68 34 00 00       	call   80104ef0 <holdingsleep>
...
80101a9a:	e8 11 34 00 00       	call   80104eb0 <releasesleep>
  iput(ip);
...
80101ab3:	68 67 7e 10 80       	push   $0x80107e67
...
80101b97:	e8 d4 36 00 00       	call   80105270 <memmove>
    brelse(bp);
...
80101c93:	e8 d8 35 00 00       	call   80105270 <memmove>
    log_write(bp);
...
80101d2e:	e8 ad 35 00 00       	call   801052e0 <strncmp>
}
80101d33:	c9                   	leave  
80101d34:	c3                   	ret    
...
80101d8d:	e8 4e 35 00 00       	call   801052e0 <strncmp>
      continue;
...
80101dd2:	68 81 7e 10 80       	push   $0x80107e81
80101dd7:	e8 a4 e5 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
80101ddc:	83 ec 0c             	sub    $0xc,%esp
80101ddf:	68 6f 7e 10 80       	push   $0x80107e6f
...
80101e1a:	e8 f1 32 00 00       	call   80105110 <acquire>
  ip->ref++;
80101e1f:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101e23:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
80101e2a:	e8 81 32 00 00       	call   801050b0 <release>
...
80101e87:	e8 e4 33 00 00       	call   80105270 <memmove>
...
80101eec:	e8 ff 2f 00 00       	call   80104ef0 <holdingsleep>
...
80101f0e:	e8 9d 2f 00 00       	call   80104eb0 <releasesleep>
  iput(ip);
...
80101f3b:	e8 30 33 00 00       	call   80105270 <memmove>
    name[len] = 0;
...
80101f8b:	e8 60 2f 00 00       	call   80104ef0 <holdingsleep>
...
80101faa:	e8 01 2f 00 00       	call   80104eb0 <releasesleep>
  iput(ip);
...
80101fcd:	e8 1e 2f 00 00       	call   80104ef0 <holdingsleep>
...
80101ff0:	e8 fb 2e 00 00       	call   80104ef0 <holdingsleep>
...
80102007:	e8 a4 2e 00 00       	call   80104eb0 <releasesleep>
}
...
8010202f:	68 67 7e 10 80       	push   $0x80107e67
...
8010209d:	e8 8e 32 00 00       	call   80105330 <strncpy>
...
801020db:	68 90 7e 10 80       	push   $0x80107e90
801020e0:	e8 9b e2 ff ff       	call   80100380 <panic>
    panic("dirlink");
801020e5:	83 ec 0c             	sub    $0xc,%esp
801020e8:	68 6a 86 10 80       	push   $0x8010866a
...
801021fb:	68 fc 7e 10 80       	push   $0x80107efc
80102200:	e8 7b e1 ff ff       	call   80100380 <panic>
    panic("idestart");
80102205:	83 ec 0c             	sub    $0xc,%esp
80102208:	68 f3 7e 10 80       	push   $0x80107ef3
...
80102226:	68 0e 7f 10 80       	push   $0x80107f0e
8010222b:	68 00 26 11 80       	push   $0x80112600
80102230:	e8 0b 2d 00 00       	call   80104f40 <initlock>
...
801022ae:	e8 5d 2e 00 00       	call   80105110 <acquire>
...
8010232b:	e8 80 2d 00 00       	call   801050b0 <release>
...
8010234e:	e8 9d 2b 00 00       	call   80104ef0 <holdingsleep>
...
80102388:	e8 83 2d 00 00       	call   80105110 <acquire>
...
801023e5:	c9                   	leave  
  release(&idelock);
801023e6:	e9 c5 2c 00 00       	jmp    801050b0 <release>
...
8010247a:	68 5c 7f 10 80       	push   $0x80107f5c
...
80102552:	e8 79 2c 00 00       	call   801051d0 <memset>
...
80102588:	e8 83 2b 00 00       	call   80105110 <acquire>
...
801025a2:	c9                   	leave  
    release(&kmem.lock);
801025a3:	e9 08 2b 00 00       	jmp    801050b0 <release>
    panic("kfree");
801025a8:	83 ec 0c             	sub    $0xc,%esp
801025ab:	68 8e 7f 10 80       	push   $0x80107f8e
...
8010267b:	68 94 7f 10 80       	push   $0x80107f94
80102680:	68 40 26 11 80       	push   $0x80112640
80102685:	e8 b6 28 00 00       	call   80104f40 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102713:	e8 f8 29 00 00       	call   80105110 <acquire>
  r = kmem.freelist;
...
80102741:	e8 6a 29 00 00       	call   801050b0 <release>
  return (char*)r;
...
8010278b:	0f b6 91 c0 80 10 80 	movzbl -0x7fef7f40(%ecx),%edx
  shift ^= togglecode[data];
80102792:	0f b6 81 c0 7f 10 80 	movzbl -0x7fef8040(%ecx),%eax
  shift |= shiftcode[data];
...
801027a8:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
801027ab:	8b 04 85 a0 7f 10 80 	mov    -0x7fef8060(,%eax,4),%eax
...
801027e5:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
801027e8:	0f b6 81 c0 80 10 80 	movzbl -0x7fef7f40(%ecx),%eax
...
80102b57:	e8 c4 26 00 00       	call   80105220 <memcmp>
...
80102c84:	e8 e7 25 00 00       	call   80105270 <memmove>
...
80102d2a:	68 c0 81 10 80       	push   $0x801081c0
80102d2f:	68 a0 26 11 80       	push   $0x801126a0
80102d34:	e8 07 22 00 00       	call   80104f40 <initlock>
  readsb(dev, &sb);
80102d39:	58                   	pop    %eax
...
80102dcb:	e8 40 23 00 00       	call   80105110 <acquire>
...
80102e3e:	e8 cd 22 00 00       	call   80105110 <acquire>
  log.outstanding -= 1;
...
80102e7c:	e8 2f 22 00 00       	call   801050b0 <release>
}
...
80102e96:	e8 75 22 00 00       	call   80105110 <acquire>
    wakeup(&log);
...
80102eb8:	e8 f3 21 00 00       	call   801050b0 <release>
...
80102f74:	e8 37 21 00 00       	call   801050b0 <release>
...
80102f87:	68 c4 81 10 80       	push   $0x801081c4
...
80102fd6:	e8 35 21 00 00       	call   80105110 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103014:	c9                   	leave  
  release(&log.lock);
80103015:	e9 96 20 00 00       	jmp    801050b0 <release>
...
80103041:	68 d3 81 10 80       	push   $0x801081d3
80103046:	e8 35 d3 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
8010304b:	83 ec 0c             	sub    $0xc,%esp
8010304e:	68 e9 81 10 80       	push   $0x801081e9
...
80103078:	68 04 82 10 80       	push   $0x80108204
8010307d:	e8 1e d6 ff ff       	call   801006a0 <cprintf>
  idtinit();       // load idt register
80103082:	e8 e9 33 00 00       	call   80106470 <idtinit>
...
801030a3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
801030a6:	e8 b5 44 00 00       	call   80107560 <switchkvm>
  seginit();
801030ab:	e8 20 44 00 00       	call   801074d0 <seginit>
  lapicinit();
...
80103104:	e8 57 36 00 00       	call   80106760 <uartinit>
  pinit();         // process table
80103109:	e8 b2 08 00 00       	call   801039c0 <pinit>
  tvinit();        // trap vectors
8010310e:	e8 dd 32 00 00       	call   801063f0 <tvinit>
  binit();         // buffer cache
...
80103134:	e8 37 21 00 00       	call   80105270 <memmove>
...
8010321e:	68 18 82 10 80       	push   $0x80108218
80103223:	56                   	push   %esi
80103224:	e8 f7 1f 00 00       	call   80105220 <memcmp>
...
801032d6:	68 1d 82 10 80       	push   $0x8010821d
801032db:	50                   	push   %eax
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
801032dc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
801032df:	e8 3c 1f 00 00       	call   80105220 <memcmp>
...
801033f3:	68 22 82 10 80       	push   $0x80108222
...
80103422:	68 18 82 10 80       	push   $0x80108218
80103427:	53                   	push   %ebx
80103428:	e8 f3 1d 00 00       	call   80105220 <memcmp>
...
80103458:	68 3c 82 10 80       	push   $0x8010823c
...
80103500:	00 00 00 
  initlock(&p->lock, "pipe");
80103503:	68 5b 82 10 80       	push   $0x8010825b
80103508:	50                   	push   %eax
80103509:	e8 32 1a 00 00       	call   80104f40 <initlock>
  (*f0)->type = FD_PIPE;
...
8010359f:	e8 6c 1b 00 00       	call   80105110 <acquire>
  if(writable){
...
8010363d:	e8 ce 1a 00 00       	call   80105110 <acquire>
  for(i = 0; i < n; i++){
...
801036cc:	e8 df 19 00 00       	call   801050b0 <release>
        return -1;
...
80103722:	e8 89 19 00 00       	call   801050b0 <release>
  return n;
...
80103746:	e8 c5 19 00 00       	call   80105110 <acquire>
...
801037de:	e8 cd 18 00 00       	call   801050b0 <release>
  return i;
...
801037f9:	e8 b2 18 00 00       	call   801050b0 <release>
      return -1;
...
80103821:	e8 ea 18 00 00       	call   80105110 <acquire>
...
8010385f:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
80103865:	e8 46 18 00 00       	call   801050b0 <release>
...
80103887:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010388a:	c7 40 14 d7 63 10 80 	movl   $0x801063d7,0x14(%eax)
  p->context = (struct context*)sp;
...
80103899:	e8 32 19 00 00       	call   801051d0 <memset>
...
801038c2:	e8 e9 17 00 00       	call   801050b0 <release>
}
...
801038fb:	e8 b0 17 00 00       	call   801050b0 <release>
...
801039c6:	68 60 82 10 80       	push   $0x80108260
801039cb:	68 20 2d 11 80       	push   $0x80112d20
801039d0:	e8 6b 15 00 00       	call   80104f40 <initlock>
}
...
80103a64:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103a67:	e8 54 15 00 00       	call   80104fc0 <pushcli>
  c = mycpu();
80103a6c:	e8 6f ff ff ff       	call   801039e0 <mycpu>
  p = c->proc;
80103a71:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a77:	e8 94 15 00 00       	call   80105010 <popcli>
}
...
80103aa3:	e8 28 3f 00 00       	call   801079d0 <setupkvm>
...
80103ac1:	e8 ba 3b 00 00       	call   80107680 <inituvm>
...
80103ad6:	e8 f5 16 00 00       	call   801051d0 <memset>
...
80103b2f:	68 90 82 10 80       	push   $0x80108290
80103b34:	50                   	push   %eax
80103b35:	e8 56 18 00 00       	call   80105390 <safestrcpy>
  p->cwd = namei("/");
80103b3a:	c7 04 24 99 82 10 80 	movl   $0x80108299,(%esp)
...
80103b50:	e8 bb 15 00 00       	call   80105110 <acquire>
...
80103b89:	83 05 58 5b 11 80 01 	addl   $0x1,0x80115b58
  release(&ptable.lock);
80103b90:	e8 1b 15 00 00       	call   801050b0 <release>
}
...
80103ba0:	68 77 82 10 80       	push   $0x80108277
...
80103bb5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103bb8:	e8 03 14 00 00       	call   80104fc0 <pushcli>
  c = mycpu();
80103bbd:	e8 1e fe ff ff       	call   801039e0 <mycpu>
  p = c->proc;
80103bc2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bc8:	e8 43 14 00 00       	call   80105010 <popcli>
  sz = curproc->sz;
...
80103bdb:	e8 90 39 00 00       	call   80107570 <switchuvm>
  return 0;
...
80103bfa:	e8 f1 3b 00 00       	call   801077f0 <allocuvm>
...
80103c1a:	e8 01 3d 00 00       	call   80107920 <deallocuvm>
...
80103c36:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103c39:	e8 82 13 00 00       	call   80104fc0 <pushcli>
  c = mycpu();
...
80103c49:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  popcli();
80103c4c:	e8 bf 13 00 00       	call   80105010 <popcli>
  if((np = allocproc()) == 0){
...
80103c6b:	e8 50 3e 00 00       	call   80107ac0 <copyuvm>
...
80103cef:	e8 9c 16 00 00       	call   80105390 <safestrcpy>
  pid = np->pid;
80103cf4:	8b 7b 10             	mov    0x10(%ebx),%edi
  acquire(&ptable.lock);
80103cf7:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103cfe:	e8 0d 14 00 00       	call   80105110 <acquire>
...
80103d35:	68 ad 7d 10 80       	push   $0x80107dad
80103d3a:	56                   	push   %esi
80103d3b:	e8 a0 15 00 00       	call   801052e0 <strncmp>
...
80103d5d:	e8 4e 13 00 00       	call   801050b0 <release>
  return pid;
...
80103d75:	68 ad 7d 10 80       	push   $0x80107dad
80103d7a:	8b 43 14             	mov    0x14(%ebx),%eax
80103d7d:	83 c0 6c             	add    $0x6c,%eax
80103d80:	50                   	push   %eax
80103d81:	e8 5a 15 00 00       	call   801052e0 <strncmp>
...
80103dfe:	e8 0d 13 00 00       	call   80105110 <acquire>
...
80103e5d:	68 f0 83 10 80       	push   $0x801083f0
...
80103ea8:	e8 03 12 00 00       	call   801050b0 <release>
  for(;;){
...
80103f39:	e8 32 36 00 00       	call   80107570 <switchuvm>
...
80103f4d:	e8 99 14 00 00       	call   801053eb <swtch>
      switchkvm();
80103f52:	e8 09 36 00 00       	call   80107560 <switchkvm>
      c->proc = 0;
...
80104073:	e8 73 13 00 00       	call   801053eb <swtch>
  mycpu()->intena = intena;
...
8010413a:	e8 d1 0f 00 00       	call   80105110 <acquire>
...
80104226:	68 e8 82 10 80       	push   $0x801082e8
...
8010423f:	68 db 82 10 80       	push   $0x801082db
...
80104272:	e8 99 0e 00 00       	call   80105110 <acquire>
...
80104287:	90                   	nop
80104288:	81 c3 b8 00 00 00    	add    $0xb8,%ebx
8010428e:	81 fb 54 5b 11 80    	cmp    $0x80115b54,%ebx
...
8010429f:	74 5f                	je     80104300 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042a1:	81 c3 b8 00 00 00    	add    $0xb8,%ebx
      havekids = 1;
801042a7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042ac:	81 fb 54 5b 11 80    	cmp    $0x80115b54,%ebx
...
801042c1:	0f 85 8f 00 00 00    	jne    80104356 <wait+0x106>
  pushcli();
801042c7:	e8 f4 0c 00 00       	call   80104fc0 <pushcli>
  c = mycpu();
801042cc:	e8 0f f7 ff ff       	call   801039e0 <mycpu>
  p = c->proc;
801042d1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801042d7:	e8 34 0d 00 00       	call   80105010 <popcli>
  if(p == 0)
...
80104319:	e8 32 36 00 00       	call   80107950 <freevm>
        p->pid = 0;
...
80104345:	e8 66 0d 00 00       	call   801050b0 <release>
        return pid;
...
8010438c:	e8 7f 0d 00 00       	call   80105110 <acquire>
  pushcli();
80104391:	e8 2a 0c 00 00       	call   80104fc0 <pushcli>
  c = mycpu();
80104396:	e8 45 f6 ff ff       	call   801039e0 <mycpu>
  p = c->proc;
8010439b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801043a1:	e8 6a 0c 00 00       	call   80105010 <popcli>
  myproc()->state = RUNNABLE;
801043a6:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  pushcli();
801043ad:	e8 0e 0c 00 00       	call   80104fc0 <pushcli>
  c = mycpu();
801043b2:	e8 29 f6 ff ff       	call   801039e0 <mycpu>
  p = c->proc;
801043b7:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801043bd:	e8 4e 0c 00 00       	call   80105010 <popcli>
  if(p->queue==CLASS1){
...
801043f3:	74 0b                	je     80104400 <yield+0x80>
      ptable.fcfs_num++;
801043f5:	83 05 5c 5b 11 80 01 	addl   $0x1,0x80115b5c
801043fc:	eb d5                	jmp    801043d3 <yield+0x53>
801043fe:	66 90                	xchg   %ax,%ax
      ptable.rr_num++;
80104400:	83 05 58 5b 11 80 01 	addl   $0x1,0x80115b58
}
...
8010441c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010441f:	e8 9c 0b 00 00       	call   80104fc0 <pushcli>
  c = mycpu();
80104424:	e8 b7 f5 ff ff       	call   801039e0 <mycpu>
  p = c->proc;
80104429:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010442f:	e8 dc 0b 00 00       	call   80105010 <popcli>
  if(p == 0)
...
80104450:	e8 bb 0c 00 00       	call   80105110 <acquire>
    release(lk);
80104455:	89 34 24             	mov    %esi,(%esp)
80104458:	e8 53 0c 00 00       	call   801050b0 <release>
  p->chan = chan;
...
8010447a:	e8 31 0c 00 00       	call   801050b0 <release>
    acquire(lk);
...
8010448b:	5d                   	pop    %ebp
    acquire(lk);
8010448c:	e9 7f 0c 00 00       	jmp    80105110 <acquire>
...
801044b9:	68 fa 82 10 80       	push   $0x801082fa
801044be:	e8 bd be ff ff       	call   80100380 <panic>
    panic("sleep");
801044c3:	83 ec 0c             	sub    $0xc,%esp
801044c6:	68 f4 82 10 80       	push   $0x801082f4
...
801044df:	e8 2c 0c 00 00       	call   80105110 <acquire>
...
801044f0:	05 b8 00 00 00       	add    $0xb8,%eax
801044f5:	3d 54 5b 11 80       	cmp    $0x80115b54,%eax
...
80104513:	75 2b                	jne    80104540 <wakeup+0x70>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104515:	05 b8 00 00 00       	add    $0xb8,%eax
    ptable.class1_num++;
8010451a:	83 05 54 5b 11 80 01 	addl   $0x1,0x80115b54
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104521:	3d 54 5b 11 80       	cmp    $0x80115b54,%eax
...
80104532:	c9                   	leave  
  release(&ptable.lock);
80104533:	e9 78 0b 00 00       	jmp    801050b0 <release>
...
80104543:	74 09                	je     8010454e <wakeup+0x7e>
      ptable.fcfs_num++;
80104545:	83 05 5c 5b 11 80 01 	addl   $0x1,0x80115b5c
8010454c:	eb a2                	jmp    801044f0 <wakeup+0x20>
      ptable.rr_num++;
8010454e:	83 05 58 5b 11 80 01 	addl   $0x1,0x80115b58
}
...
8010456f:	e8 9c 0b 00 00       	call   80105110 <acquire>
...
80104580:	05 b8 00 00 00       	add    $0xb8,%eax
80104585:	3d 54 5b 11 80       	cmp    $0x80115b54,%eax
...
801045a6:	e8 05 0b 00 00       	call   801050b0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801045c0:	e8 eb 0a 00 00       	call   801050b0 <release>
}
...
801045dd:	75 10                	jne    801045ef <kill+0x8f>
    ptable.class1_num++;
801045df:	83 05 54 5b 11 80 01 	addl   $0x1,0x80115b54
        p->state = RUNNABLE;
...
801045f2:	74 09                	je     801045fd <kill+0x9d>
      ptable.fcfs_num++;
801045f4:	83 05 5c 5b 11 80 01 	addl   $0x1,0x80115b5c
801045fb:	eb e9                	jmp    801045e6 <kill+0x86>
      ptable.rr_num++;
801045fd:	83 05 58 5b 11 80 01 	addl   $0x1,0x80115b58
}
...
8010462b:	68 2c 83 10 80       	push   $0x8010832c
80104630:	e8 6b c0 ff ff       	call   801006a0 <cprintf>
80104635:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104638:	81 c3 b8 00 00 00    	add    $0xb8,%ebx
8010463e:	81 fb c0 5b 11 80    	cmp    $0x80115bc0,%ebx
...
8010464f:	74 e7                	je     80104638 <procdump+0x28>
      state = "???";
80104651:	ba 0b 83 10 80       	mov    $0x8010830b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104656:	83 f8 05             	cmp    $0x5,%eax
80104659:	77 11                	ja     8010466c <procdump+0x5c>
8010465b:	8b 14 85 5c 85 10 80 	mov    -0x7fef7aa4(,%eax,4),%edx
      state = "???";
80104662:	b8 0b 83 10 80       	mov    $0x8010830b,%eax
...
80104671:	68 0f 83 10 80       	push   $0x8010830f
...
80104698:	e8 c3 08 00 00       	call   80104f60 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801046ad:	68 61 7d 10 80       	push   $0x80107d61
...
801046de:	e8 ad 0d 00 00       	call   80105490 <argint>
...
801046f7:	e8 94 0d 00 00       	call   80105490 <argint>
...
8010471f:	e8 ec 09 00 00       	call   80105110 <acquire>
        if(p->pid == pid){
...
8010472f:	90                   	nop
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104730:	81 c3 b8 00 00 00    	add    $0xb8,%ebx
80104736:	81 fb 54 5b 11 80    	cmp    $0x80115b54,%ebx
...
8010475e:	e8 4d 09 00 00       	call   801050b0 <release>
                cprintf("Not in class2, can't change level!\n");
80104763:	c7 04 24 64 84 10 80 	movl   $0x80108464,(%esp)
...
80104788:	e8 23 09 00 00       	call   801050b0 <release>
    return -1; // pid not found
...
801047a4:	e8 07 09 00 00       	call   801050b0 <release>
            cprintf("the process is in this level now, can't change level!\n");
801047a9:	c7 04 24 2c 84 10 80 	movl   $0x8010842c,(%esp)
...
801047c8:	68 2c 83 10 80       	push   $0x8010832c
...
801047d8:	68 2c 83 10 80       	push   $0x8010832c
                p->queue = new_level;
...
801047ec:	e8 bf 08 00 00       	call   801050b0 <release>
                cprintf("changing level done!\n");
801047f1:	c7 04 24 18 83 10 80 	movl   $0x80108318,(%esp)
...
80104811:	b8 2e 83 10 80       	mov    $0x8010832e,%eax
...
80104820:	8b 04 95 44 85 10 80 	mov    -0x7fef7abc(,%edx,4),%eax
...
80104831:	b8 36 83 10 80       	mov    $0x80108336,%eax
...
80104840:	8b 04 95 38 85 10 80 	mov    -0x7fef7ac8(,%edx,4),%eax
...
80104859:	b8 36 83 10 80       	mov    $0x80108336,%eax
8010485e:	83 fa 02             	cmp    $0x2,%edx
80104861:	77 07                	ja     8010486a <getAlgorithmString+0x1a>
80104863:	8b 04 95 2c 85 10 80 	mov    -0x7fef7ad4(,%edx,4),%eax
...
801048d3:	83 c3 01             	add    $0x1,%ebx
    cprintf(" ");
801048d6:	68 be 83 10 80       	push   $0x801083be
...
80104903:	e8 08 08 00 00       	call   80105110 <acquire>

  cprintf("name            pid  state class   algorithm wait_time deadline cons_run arrival\n"
80104908:	c7 04 24 88 84 10 80 	movl   $0x80108488,(%esp)
...
80104926:	81 fb c0 5b 11 80    	cmp    $0x80115bc0,%ebx
...
80104942:	68 15 83 10 80       	push   $0x80108315
80104947:	e8 54 bd ff ff       	call   801006a0 <cprintf>
    printspaces(columns[0] - strlen(p->name));
8010494c:	89 1c 24             	mov    %ebx,(%esp)
8010494f:	e8 7c 0a 00 00       	call   801053d0 <strlen>
  for (int i = 0; i < count; i++) {
...
80104963:	83 c7 01             	add    $0x1,%edi
    cprintf(" ");
80104966:	68 be 83 10 80       	push   $0x801083be
...
8010497d:	68 3e 83 10 80       	push   $0x8010833e
...
801049d3:	83 c7 01             	add    $0x1,%edi
    cprintf(" ");
801049d6:	68 be 83 10 80       	push   $0x801083be
...
801049ea:	be 2e 83 10 80       	mov    $0x8010832e,%esi
801049ef:	83 f8 05             	cmp    $0x5,%eax
801049f2:	77 07                	ja     801049fb <printprocinfo+0x10b>
801049f4:	8b 34 85 44 85 10 80 	mov    -0x7fef7abc(,%eax,4),%esi
    cprintf("%s", stateStr);
801049fb:	83 ec 08             	sub    $0x8,%esp
801049fe:	56                   	push   %esi
801049ff:	68 15 83 10 80       	push   $0x80108315
...
80104a11:	e8 ba 09 00 00       	call   801053d0 <strlen>
  for (int i = 0; i < count; i++) {
...
80104a2b:	83 c7 01             	add    $0x1,%edi
    cprintf(" ");
80104a2e:	68 be 83 10 80       	push   $0x801083be
...
80104a42:	be 36 83 10 80       	mov    $0x80108336,%esi
80104a47:	83 f8 02             	cmp    $0x2,%eax
80104a4a:	77 07                	ja     80104a53 <printprocinfo+0x163>
80104a4c:	8b 34 85 38 85 10 80 	mov    -0x7fef7ac8(,%eax,4),%esi
    cprintf("%s", classStr);
80104a53:	83 ec 08             	sub    $0x8,%esp
80104a56:	56                   	push   %esi
80104a57:	68 15 83 10 80       	push   $0x80108315
...
80104a69:	e8 62 09 00 00       	call   801053d0 <strlen>
  for (int i = 0; i < count; i++) {
...
80104a83:	83 c7 01             	add    $0x1,%edi
    cprintf(" ");
80104a86:	68 be 83 10 80       	push   $0x801083be
...
80104ac1:	e8 0a 09 00 00       	call   801053d0 <strlen>
  for (int i = 0; i < count; i++) {
...
80104adb:	83 c7 01             	add    $0x1,%edi
    cprintf(" ");
80104ade:	68 be 83 10 80       	push   $0x801083be
...
80104af2:	ff 73 40             	push   0x40(%ebx)
80104af5:	68 3e 83 10 80       	push   $0x8010833e
80104afa:	e8 a1 bb ff ff       	call   801006a0 <cprintf>
    printspaces(columns[5] - count_digits(p->wait_time));
80104aff:	8b 53 40             	mov    0x40(%ebx),%edx
  if (number == 0)
...
80104b43:	83 c7 01             	add    $0x1,%edi
    cprintf(" ");
80104b46:	68 be 83 10 80       	push   $0x801083be
...
80104b5d:	68 3e 83 10 80       	push   $0x8010833e
...
80104bb3:	83 c7 01             	add    $0x1,%edi
    cprintf(" ");
80104bb6:	68 be 83 10 80       	push   $0x801083be
...
80104bca:	ff 73 44             	push   0x44(%ebx)
80104bcd:	68 3e 83 10 80       	push   $0x8010833e
80104bd2:	e8 c9 ba ff ff       	call   801006a0 <cprintf>
    printspaces(columns[7] - count_digits(p->consecutive_run_ticks));
80104bd7:	8b 53 44             	mov    0x44(%ebx),%edx
  if (number == 0)
...
80104c23:	83 c7 01             	add    $0x1,%edi
    cprintf(" ");
80104c26:	68 be 83 10 80       	push   $0x801083be
...
80104c3a:	ff 73 48             	push   0x48(%ebx)
80104c3d:	68 3e 83 10 80       	push   $0x8010833e
80104c42:	e8 59 ba ff ff       	call   801006a0 <cprintf>
    printspaces(columns[8] - count_digits(p->queue_arrival_time));
80104c47:	8b 53 48             	mov    0x48(%ebx),%edx
  if (number == 0)
...
80104c93:	83 c7 01             	add    $0x1,%edi
    cprintf(" ");
80104c96:	68 be 83 10 80       	push   $0x801083be
...
80104ca7:	83 ec 0c             	sub    $0xc,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104caa:	81 c3 b8 00 00 00    	add    $0xb8,%ebx
    cprintf("\n");
80104cb0:	68 2c 83 10 80       	push   $0x8010832c
80104cb5:	e8 e6 b9 ff ff       	call   801006a0 <cprintf>
80104cba:	83 c4 10             	add    $0x10,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104cbd:	81 fb c0 5b 11 80    	cmp    $0x80115bc0,%ebx
...
80104cd1:	e8 da 03 00 00       	call   801050b0 <release>
}
...
80104d33:	83 ec 20             	sub    $0x20,%esp
  int pid, dead_line;
    ...
    if(argint(0, &pid) < 0)
80104d36:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d39:	50                   	push   %eax
80104d3a:	6a 00                	push   $0x0
80104d3c:	e8 4f 07 00 00       	call   80105490 <argint>
80104d41:	83 c4 10             	add    $0x10,%esp
80104d44:	85 c0                	test   %eax,%eax
80104d46:	0f 88 84 00 00 00    	js     80104dd0 <sys_dl_proc+0xa0>
        return -1;
...
80104d55:	e8 36 07 00 00       	call   80105490 <argint>
80104d5a:	83 c4 10             	add    $0x10,%esp
80104d5d:	85 c0                	test   %eax,%eax
80104d5f:	78 6f                	js     80104dd0 <sys_dl_proc+0xa0>
        return -1;
    int flag = 0;
    acquire(&ptable.lock);
80104d61:	83 ec 0c             	sub    $0xc,%esp
80104d64:	68 20 2d 11 80       	push   $0x80112d20
80104d69:	e8 a2 03 00 00       	call   80105110 <acquire>
    for(int index = 0; index < NPROC; index++) {
      if(ptable.proc[index].pid == pid) {
80104d6e:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80104d71:	ba 64 2d 11 80       	mov    $0x80112d64,%edx
80104d76:	83 c4 10             	add    $0x10,%esp
    for(int index = 0; index < NPROC; index++) {
80104d79:	31 c0                	xor    %eax,%eax
80104d7b:	eb 11                	jmp    80104d8e <sys_dl_proc+0x5e>
80104d7d:	8d 76 00             	lea    0x0(%esi),%esi
80104d80:	83 c0 01             	add    $0x1,%eax
80104d83:	81 c2 b8 00 00 00    	add    $0xb8,%edx
80104d89:	83 f8 40             	cmp    $0x40,%eax
80104d8c:	74 52                	je     80104de0 <sys_dl_proc+0xb0>
      if(ptable.proc[index].pid == pid) {
80104d8e:	39 0a                	cmp    %ecx,(%edx)
80104d90:	75 ee                	jne    80104d80 <sys_dl_proc+0x50>
...
80104d95:	69 c0 b8 00 00 00    	imul   $0xb8,%eax,%eax
80104d9b:	8b 55 f4             	mov    -0xc(%ebp),%edx
    release(&ptable.lock);
80104d9e:	68 20 2d 11 80       	push   $0x80112d20
        ptable.proc[index].deadline = dead_line;
80104da3:	89 90 d8 2d 11 80    	mov    %edx,-0x7feed228(%eax)
        ptable.proc[index].queue = CLASS1;
80104da9:	c7 80 d0 2d 11 80 00 	movl   $0x0,-0x7feed230(%eax)
80104db0:	00 00 00 
    release(&ptable.lock);
80104db3:	e8 f8 02 00 00       	call   801050b0 <release>
    if(flag == 1){
      printprocinfo();
80104db8:	e8 33 fb ff ff       	call   801048f0 <printprocinfo>
...
80104de3:	68 20 2d 11 80       	push   $0x80112d20
80104de8:	e8 c3 02 00 00       	call   801050b0 <release>
      cprintf("proc not found!");
80104ded:	c7 04 24 41 83 10 80 	movl   $0x80108341,(%esp)
80104df4:	e8 a7 b8 ff ff       	call   801006a0 <cprintf>
80104df9:	83 c4 10             	add    $0x10,%esp
    return 1;
80104dfc:	b8 01 00 00 00       	mov    $0x1,%eax
80104e01:	c9                   	leave  
80104e02:	c3                   	ret    
80104e03:	66 90                	xchg   %ax,%ax
80104e05:	66 90                	xchg   %ax,%ax
...
80104e1a:	68 74 85 10 80       	push   $0x80108574
...
80104e75:	e8 96 f5 ff ff       	call   80104410 <sleep>
  while (lk->locked) {
...
80104e83:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104e89:	e8 d2 eb ff ff       	call   80103a60 <myproc>
...
80104ed4:	e8 f7 f5 ff ff       	call   801044d0 <wakeup>
  release(&lk->lk);
...
80104f2b:	e8 30 eb ff ff       	call   80103a60 <myproc>
...
80104fea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80104ff0:	e8 eb e9 ff ff       	call   801039e0 <mycpu>
...
8010503c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80105040:	e8 9b e9 ff ff       	call   801039e0 <mycpu>
...
80105055:	68 7f 85 10 80       	push   $0x8010857f
8010505a:	e8 21 b3 ff ff       	call   80100380 <panic>
    panic("popcli");
8010505f:	83 ec 0c             	sub    $0xc,%esp
80105062:	68 96 85 10 80       	push   $0x80108596
...
80105093:	e8 48 e9 ff ff       	call   801039e0 <mycpu>
...
8010514c:	e8 8f e8 ff ff       	call   801039e0 <mycpu>
...
801051ab:	e8 30 e8 ff ff       	call   801039e0 <mycpu>
...
801051c0:	68 a5 85 10 80       	push   $0x801085a5
...
80105407:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010540a:	e8 51 e6 ff ff       	call   80103a60 <myproc>
...
80105447:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010544a:	e8 11 e6 ff ff       	call   80103a60 <myproc>
...
80105495:	e8 c6 e5 ff ff       	call   80103a60 <myproc>
...
801054a3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801054a6:	e8 b5 e5 ff ff       	call   80103a60 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
801054e6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
801054e9:	e8 72 e5 ff ff       	call   80103a60 <myproc>
801054ee:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801054f0:	e8 6b e5 ff ff       	call   80103a60 <myproc>
...
801054fe:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80105501:	e8 5a e5 ff ff       	call   80103a60 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80105554:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80105555:	e8 06 e5 ff ff       	call   80103a60 <myproc>
...
80105563:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80105566:	e8 f5 e4 ff ff       	call   80103a60 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
8010557b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
8010557e:	e8 dd e4 ff ff       	call   80103a60 <myproc>
  if(addr >= curproc->sz)
...
801055d4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801055d7:	e8 84 e4 ff ff       	call   80103a60 <myproc>
...
801055e7:	83 fa 17             	cmp    $0x17,%edx
801055ea:	77 24                	ja     80105610 <syscall+0x40>
801055ec:	8b 14 85 e0 85 10 80 	mov    -0x7fef7a20(,%eax,4),%edx
...
80105618:	68 ad 85 10 80       	push   $0x801085ad
...
80105657:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010565a:	e8 c1 ca ff ff       	call   80102120 <nameiparent>
...
80105670:	e8 6b c1 ff ff       	call   801017e0 <ilock>
...
8010567c:	e8 bf c6 ff ff       	call   80101d40 <dirlookup>
...
8010568e:	e8 dd c3 ff ff       	call   80101a70 <iunlockput>
    ilock(ip);
80105693:	89 34 24             	mov    %esi,(%esp)
80105696:	e8 45 c1 ff ff       	call   801017e0 <ilock>
...
801056c4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
801056c6:	e8 a5 c3 ff ff       	call   80101a70 <iunlockput>
    return 0;
...
801056ea:	e8 81 bf ff ff       	call   80101670 <ialloc>
...
80105700:	e8 db c0 ff ff       	call   801017e0 <ilock>
  ip->major = major;
...
80105721:	e8 0a c0 ff ff       	call   80101730 <iupdate>
...
80105738:	e8 03 c9 ff ff       	call   80102040 <dirlink>
...
80105748:	e8 23 c3 ff ff       	call   80101a70 <iunlockput>
  return ip;
...
80105769:	e8 c2 bf ff ff       	call   80101730 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010576e:	83 c4 0c             	add    $0xc,%esp
80105771:	ff 76 04             	push   0x4(%esi)
80105774:	68 60 86 10 80       	push   $0x80108660
80105779:	56                   	push   %esi
8010577a:	e8 c1 c8 ff ff       	call   80102040 <dirlink>
...
8010578c:	68 5f 86 10 80       	push   $0x8010865f
80105791:	56                   	push   %esi
80105792:	e8 a9 c8 ff ff       	call   80102040 <dirlink>
...
801057a1:	68 53 86 10 80       	push   $0x80108653
...
801057bf:	68 62 86 10 80       	push   $0x80108662
801057c4:	e8 b7 ab ff ff       	call   80100380 <panic>
    panic("create: ialloc");
801057c9:	83 ec 0c             	sub    $0xc,%esp
801057cc:	68 44 86 10 80       	push   $0x80108644
...
80105800:	e8 5b e2 ff ff       	call   80103a60 <myproc>
...
8010580e:	74 20                	je     80105830 <sys_dup+0x50>
  struct proc *curproc = myproc();
80105810:	e8 4b e2 ff ff       	call   80103a60 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105848:	e8 b3 b6 ff ff       	call   80100f00 <filedup>
  return fd;
...
80105880:	e8 db e1 ff ff       	call   80103a60 <myproc>
...
801058c4:	e8 b7 b7 ff ff       	call   80101080 <fileread>
...
80105944:	e8 c7 b7 ff ff       	call   80101110 <filewrite>
...
80105980:	e8 db e0 ff ff       	call   80103a60 <myproc>
...
80105991:	74 25                	je     801059b8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105993:	e8 c8 e0 ff ff       	call   80103a60 <myproc>
  fileclose(f);
...
801059a4:	e8 a7 b5 ff ff       	call   80100f50 <fileclose>
  return 0;
...
801059e0:	e8 7b e0 ff ff       	call   80103a60 <myproc>
...
80105a0b:	e8 20 b6 ff ff       	call   80101030 <filestat>
...
80105a62:	0f 88 e2 00 00 00    	js     80105b4a <sys_link+0x11a>
  begin_op();
80105a68:	e8 53 d3 ff ff       	call   80102dc0 <begin_op>
  if((ip = namei(old)) == 0){
80105a6d:	83 ec 0c             	sub    $0xc,%esp
80105a70:	ff 75 d4             	push   -0x2c(%ebp)
80105a73:	e8 88 c6 ff ff       	call   80102100 <namei>
...
80105a89:	e8 52 bd ff ff       	call   801017e0 <ilock>
  if(ip->type == T_DIR){
...
80105aa8:	e8 83 bc ff ff       	call   80101730 <iupdate>
  iunlock(ip);
80105aad:	89 1c 24             	mov    %ebx,(%esp)
80105ab0:	e8 0b be ff ff       	call   801018c0 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105ab5:	58                   	pop    %eax
80105ab6:	5a                   	pop    %edx
80105ab7:	57                   	push   %edi
80105ab8:	ff 75 d0             	push   -0x30(%ebp)
80105abb:	e8 60 c6 ff ff       	call   80102120 <nameiparent>
...
80105acd:	e8 0e bd ff ff       	call   801017e0 <ilock>
...
80105ae3:	e8 58 c5 ff ff       	call   80102040 <dirlink>
...
80105af3:	e8 78 bf ff ff       	call   80101a70 <iunlockput>
  iput(ip);
80105af8:	89 1c 24             	mov    %ebx,(%esp)
80105afb:	e8 10 be ff ff       	call   80101910 <iput>
  end_op();
80105b00:	e8 2b d3 ff ff       	call   80102e30 <end_op>
  return 0;
...
80105b1c:	e8 4f bf ff ff       	call   80101a70 <iunlockput>
    goto bad;
...
80105b35:	e8 f6 bb ff ff       	call   80101730 <iupdate>
  iunlockput(ip);
80105b3a:	89 1c 24             	mov    %ebx,(%esp)
80105b3d:	e8 2e bf ff ff       	call   80101a70 <iunlockput>
  end_op();
80105b42:	e8 e9 d2 ff ff       	call   80102e30 <end_op>
  return -1;
...
80105b55:	e8 16 bf ff ff       	call   80101a70 <iunlockput>
    end_op();
80105b5a:	e8 d1 d2 ff ff       	call   80102e30 <end_op>
    return -1;
80105b5f:	83 c4 10             	add    $0x10,%esp
80105b62:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b67:	eb a1                	jmp    80105b0a <sys_link+0xda>
    end_op();
80105b69:	e8 c2 d2 ff ff       	call   80102e30 <end_op>
    return -1;
...
80105bc8:	e8 13 bc ff ff       	call   801017e0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105bcd:	58                   	pop    %eax
80105bce:	5a                   	pop    %edx
80105bcf:	68 60 86 10 80       	push   $0x80108660
80105bd4:	53                   	push   %ebx
80105bd5:	e8 46 c1 ff ff       	call   80101d20 <namecmp>
...
80105be8:	68 5f 86 10 80       	push   $0x8010865f
80105bed:	53                   	push   %ebx
80105bee:	e8 2d c1 ff ff       	call   80101d20 <namecmp>
...
80105c07:	e8 34 c1 ff ff       	call   80101d40 <dirlookup>
...
80105c1d:	e8 be bb ff ff       	call   801017e0 <ilock>
  if(ip->nlink < 1)
...
80105c50:	e8 9b bf ff ff       	call   80101bf0 <writei>
...
80105c72:	e8 f9 bd ff ff       	call   80101a70 <iunlockput>
  ip->nlink--;
80105c77:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105c7c:	89 1c 24             	mov    %ebx,(%esp)
80105c7f:	e8 ac ba ff ff       	call   80101730 <iupdate>
  iunlockput(ip);
80105c84:	89 1c 24             	mov    %ebx,(%esp)
80105c87:	e8 e4 bd ff ff       	call   80101a70 <iunlockput>
  end_op();
80105c8c:	e8 9f d1 ff ff       	call   80102e30 <end_op>
  return 0;
...
80105cbd:	e8 2e be ff ff       	call   80101af0 <readi>
...
80105cd5:	e8 96 bd ff ff       	call   80101a70 <iunlockput>
    goto bad;
...
80105ce6:	e8 85 bd ff ff       	call   80101a70 <iunlockput>
  end_op();
80105ceb:	e8 40 d1 ff ff       	call   80102e30 <end_op>
  return -1;
...
80105d0c:	e8 1f ba ff ff       	call   80101730 <iupdate>
...
80105d1e:	e9 73 ff ff ff       	jmp    80105c96 <sys_unlink+0x116>
    end_op();
80105d23:	e8 08 d1 ff ff       	call   80102e30 <end_op>
    return -1;
...
80105d92:	78 79                	js     80105e0d <sys_open+0xad>
  ...
  begin_op();
80105d94:	e8 27 d0 ff ff       	call   80102dc0 <begin_op>
...
80105da5:	e8 56 c3 ff ff       	call   80102100 <namei>
...
80105dbb:	e8 20 ba ff ff       	call   801017e0 <ilock>
...
80105dce:	e8 bd b0 ff ff       	call   80100e90 <filealloc>
...
80105df4:	e8 57 b1 ff ff       	call   80100f50 <fileclose>
80105df9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
80105dfc:	83 ec 0c             	sub    $0xc,%esp
80105dff:	56                   	push   %esi
80105e00:	e8 6b bc ff ff       	call   80101a70 <iunlockput>
    end_op();
80105e05:	e8 26 d0 ff ff       	call   80102e30 <end_op>
    return -1;
...
80105e33:	75 99                	jne    80105dce <sys_open+0x6e>
      end_op();
80105e35:	e8 f6 cf ff ff       	call   80102e30 <end_op>
      return -1;
...
80105e50:	e8 6b ba ff ff       	call   801018c0 <iunlock>
  end_op();
80105e55:	e8 d6 cf ff ff       	call   80102e30 <end_op>
...
80105ea3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105ea6:	e8 15 cf ff ff       	call   80102dc0 <begin_op>
...
80105edf:	e8 8c bb ff ff       	call   80101a70 <iunlockput>
  end_op();
80105ee4:	e8 47 cf ff ff       	call   80102e30 <end_op>
  return 0;
...
80105eef:	c3                   	ret    
    end_op();
80105ef0:	e8 3b cf ff ff       	call   80102e30 <end_op>
    return -1;
...
80105f03:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105f06:	e8 b5 ce ff ff       	call   80102dc0 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
80105f6e:	e8 fd ba ff ff       	call   80101a70 <iunlockput>
  end_op();
80105f73:	e8 b8 ce ff ff       	call   80102e30 <end_op>
  return 0;
...
80105f7f:	90                   	nop
    end_op();
80105f80:	e8 ab ce ff ff       	call   80102e30 <end_op>
    return -1;
...
80105f95:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105f98:	e8 c3 da ff ff       	call   80103a60 <myproc>
80105f9d:	89 c6                	mov    %eax,%esi
  
  begin_op();
80105f9f:	e8 1c ce ff ff       	call   80102dc0 <begin_op>
...
80105fbf:	e8 3c c1 ff ff       	call   80102100 <namei>
...
80105fd1:	e8 0a b8 ff ff       	call   801017e0 <ilock>
  if(ip->type != T_DIR){
...
80105fe4:	e8 d7 b8 ff ff       	call   801018c0 <iunlock>
  iput(curproc->cwd);
80105fe9:	58                   	pop    %eax
80105fea:	ff 76 68             	push   0x68(%esi)
80105fed:	e8 1e b9 ff ff       	call   80101910 <iput>
  end_op();
80105ff2:	e8 39 ce ff ff       	call   80102e30 <end_op>
  curproc->cwd = ip;
...
80106014:	e8 57 ba ff ff       	call   80101a70 <iunlockput>
    end_op();
80106019:	e8 12 ce ff ff       	call   80102e30 <end_op>
    return -1;
...
8010602f:	90                   	nop
    end_op();
80106030:	e8 fb cd ff ff       	call   80102e30 <end_op>
    return -1;
...
80106158:	e8 33 d3 ff ff       	call   80103490 <pipealloc>
...
80106167:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80106169:	e8 f2 d8 ff ff       	call   80103a60 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80106186:	e8 c5 ad ff ff       	call   80100f50 <fileclose>
    fileclose(wf);
8010618b:	58                   	pop    %eax
8010618c:	ff 75 e4             	push   -0x1c(%ebp)
8010618f:	e8 bc ad ff ff       	call   80100f50 <fileclose>
    return -1;
...
801061a7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801061aa:	e8 b1 d8 ff ff       	call   80103a60 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801061c6:	75 f0                	jne    801061b8 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
801061c8:	e8 93 d8 ff ff       	call   80103a60 <myproc>
...
{
  return fork();
80106200:	e9 2b da ff ff       	jmp    80103c30 <fork>
...
80106213:	83 ec 08             	sub    $0x8,%esp
  exit();
80106216:	e8 b5 de ff ff       	call   801040d0 <exit>
...
{
  return wait();
80106220:	e9 2b e0 ff ff       	jmp    80104250 <wait>
...
8010624e:	e8 0d e3 ff ff       	call   80104560 <kill>
...
80106273:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80106276:	e8 e5 d7 ff ff       	call   80103a60 <myproc>
...
80106297:	78 27                	js     801062c0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80106299:	e8 c2 d7 ff ff       	call   80103a60 <myproc>
  if(growproc(n) < 0)
...
801062a6:	e8 05 d9 ff ff       	call   80103bb0 <growproc>
...
801062f0:	68 a0 5b 11 80       	push   $0x80115ba0
801062f5:	e8 16 ee ff ff       	call   80105110 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801062fa:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801062fd:	8b 1d 80 5b 11 80    	mov    0x80115b80,%ebx
  while(ticks - ticks0 < n){
...
80106313:	68 a0 5b 11 80       	push   $0x80115ba0
80106318:	68 80 5b 11 80       	push   $0x80115b80
8010631d:	e8 ee e0 ff ff       	call   80104410 <sleep>
  while(ticks - ticks0 < n){
80106322:	a1 80 5b 11 80       	mov    0x80115b80,%eax
...
8010632f:	73 2f                	jae    80106360 <sys_sleep+0x90>
    if(myproc()->killed){
80106331:	e8 2a d7 ff ff       	call   80103a60 <myproc>
...
80106340:	68 a0 5b 11 80       	push   $0x80115ba0
...
80106363:	68 a0 5b 11 80       	push   $0x80115ba0
...
80106384:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80106387:	68 a0 5b 11 80       	push   $0x80115ba0
8010638c:	e8 7f ed ff ff       	call   80105110 <acquire>
  xticks = ticks;
80106391:	8b 1d 80 5b 11 80    	mov    0x80115b80,%ebx
  release(&tickslock);
80106397:	c7 04 24 a0 5b 11 80 	movl   $0x80115ba0,(%esp)
...
801063b3:	83 ec 08             	sub    $0x8,%esp
  printprocinfo();
801063b6:	e8 35 e5 ff ff       	call   801048f0 <printprocinfo>
  return 0;
}
...
801063c0:	06                   	push   %es
  pushl %fs
801063c1:	0f a0                	push   %fs
  pushl %gs
801063c3:	0f a8                	push   %gs
  pushal
801063c5:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801063c6:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801063ca:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801063cc:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801063ce:	54                   	push   %esp
  call trap
801063cf:	e8 cc 00 00 00       	call   801064a0 <trap>
  addl $4, %esp
...
801063d7:	61                   	popa   
  popl %gs
801063d8:	0f a9                	pop    %gs
  popl %fs
801063da:	0f a1                	pop    %fs
  popl %es
801063dc:	07                   	pop    %es
  popl %ds
801063dd:	1f                   	pop    %ds
...
80106400:	8b 14 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%edx
80106407:	c7 04 c5 e2 5b 11 80 	movl   $0x8e000008,-0x7feea41e(,%eax,8)
8010640e:	08 00 00 8e 
80106412:	66 89 14 c5 e0 5b 11 	mov    %dx,-0x7feea420(,%eax,8)
80106419:	80 
8010641a:	c1 ea 10             	shr    $0x10,%edx
8010641d:	66 89 14 c5 e6 5b 11 	mov    %dx,-0x7feea41a(,%eax,8)
80106424:	80 
  for(i = 0; i < 256; i++)
80106425:	83 c0 01             	add    $0x1,%eax
80106428:	3d 00 01 00 00       	cmp    $0x100,%eax
8010642d:	75 d1                	jne    80106400 <tvinit+0x10>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);

  initlock(&tickslock, "time");
8010642f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106432:	a1 08 b1 10 80       	mov    0x8010b108,%eax
80106437:	c7 05 e2 5d 11 80 08 	movl   $0xef000008,0x80115de2
8010643e:	00 00 ef 
  initlock(&tickslock, "time");
80106441:	68 62 83 10 80       	push   $0x80108362
80106446:	68 a0 5b 11 80       	push   $0x80115ba0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010644b:	66 a3 e0 5d 11 80    	mov    %ax,0x80115de0
80106451:	c1 e8 10             	shr    $0x10,%eax
80106454:	66 a3 e6 5d 11 80    	mov    %ax,0x80115de6
  initlock(&tickslock, "time");
8010645a:	e8 e1 ea ff ff       	call   80104f40 <initlock>
}
8010645f:	83 c4 10             	add    $0x10,%esp
80106462:	c9                   	leave  
80106463:	c3                   	ret    
80106464:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
8010647b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010647f:	b8 e0 5b 11 80       	mov    $0x80115be0,%eax
...
801064b2:	0f 84 68 01 00 00    	je     80106620 <trap+0x180>
  ...
  switch(tf->trapno){
801064b8:	83 e8 20             	sub    $0x20,%eax
801064bb:	83 f8 1f             	cmp    $0x1f,%eax
801064be:	0f 87 8c 00 00 00    	ja     80106550 <trap+0xb0>
801064c4:	ff 24 85 48 87 10 80 	jmp    *-0x7fef78b8(,%eax,4)
...
801064cf:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801064d0:	e8 cb bd ff ff       	call   801022a0 <ideintr>
    lapiceoi();
801064d5:	e8 96 c4 ff ff       	call   80102970 <lapiceoi>
  }
...
801064da:	e8 81 d5 ff ff       	call   80103a60 <myproc>
801064df:	85 c0                	test   %eax,%eax
801064e1:	74 1d                	je     80106500 <trap+0x60>
801064e3:	e8 78 d5 ff ff       	call   80103a60 <myproc>
801064e8:	8b 50 24             	mov    0x24(%eax),%edx
801064eb:	85 d2                	test   %edx,%edx
801064ed:	74 11                	je     80106500 <trap+0x60>
801064ef:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801064f3:	83 e0 03             	and    $0x3,%eax
801064f6:	66 83 f8 03          	cmp    $0x3,%ax
801064fa:	0f 84 e8 01 00 00    	je     801066e8 <trap+0x248>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80106500:	e8 5b d5 ff ff       	call   80103a60 <myproc>
80106505:	85 c0                	test   %eax,%eax
80106507:	74 0f                	je     80106518 <trap+0x78>
80106509:	e8 52 d5 ff ff       	call   80103a60 <myproc>
8010650e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80106512:	0f 84 b8 00 00 00    	je     801065d0 <trap+0x130>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106518:	e8 43 d5 ff ff       	call   80103a60 <myproc>
8010651d:	85 c0                	test   %eax,%eax
8010651f:	74 1d                	je     8010653e <trap+0x9e>
80106521:	e8 3a d5 ff ff       	call   80103a60 <myproc>
80106526:	8b 40 24             	mov    0x24(%eax),%eax
80106529:	85 c0                	test   %eax,%eax
8010652b:	74 11                	je     8010653e <trap+0x9e>
8010652d:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80106531:	83 e0 03             	and    $0x3,%eax
80106534:	66 83 f8 03          	cmp    $0x3,%ax
80106538:	0f 84 0f 01 00 00    	je     8010664d <trap+0x1ad>
    exit();
}
...
80106555:	8b 7b 38             	mov    0x38(%ebx),%edi
80106558:	85 c0                	test   %eax,%eax
8010655a:	0f 84 a2 01 00 00    	je     80106702 <trap+0x262>
80106560:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80106564:	0f 84 98 01 00 00    	je     80106702 <trap+0x262>
...
80106570:	e8 cb d4 ff ff       	call   80103a40 <cpuid>
80106575:	8b 73 30             	mov    0x30(%ebx),%esi
80106578:	89 45 dc             	mov    %eax,-0x24(%ebp)
8010657b:	8b 43 34             	mov    0x34(%ebx),%eax
8010657e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            myproc()->pid, myproc()->name, tf->trapno,
80106581:	e8 da d4 ff ff       	call   80103a60 <myproc>
80106586:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106589:	e8 d2 d4 ff ff       	call   80103a60 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80106597:	ff 75 e4             	push   -0x1c(%ebp)
8010659a:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
8010659b:	8b 75 e0             	mov    -0x20(%ebp),%esi
8010659e:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801065a1:	56                   	push   %esi
801065a2:	ff 70 10             	push   0x10(%eax)
801065a5:	68 04 87 10 80       	push   $0x80108704
801065aa:	e8 f1 a0 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
801065af:	83 c4 20             	add    $0x20,%esp
801065b2:	e8 a9 d4 ff ff       	call   80103a60 <myproc>
801065b7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801065be:	e8 9d d4 ff ff       	call   80103a60 <myproc>
801065c3:	85 c0                	test   %eax,%eax
801065c5:	0f 85 18 ff ff ff    	jne    801064e3 <trap+0x43>
801065cb:	e9 30 ff ff ff       	jmp    80106500 <trap+0x60>
  if(myproc() && myproc()->state == RUNNING &&
801065d0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
801065d4:	0f 85 3e ff ff ff    	jne    80106518 <trap+0x78>
    yield();
801065da:	e8 a1 dd ff ff       	call   80104380 <yield>
801065df:	e9 34 ff ff ff       	jmp    80106518 <trap+0x78>
801065e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801065e8:	8b 7b 38             	mov    0x38(%ebx),%edi
801065eb:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
801065ef:	e8 4c d4 ff ff       	call   80103a40 <cpuid>
801065f4:	57                   	push   %edi
801065f5:	56                   	push   %esi
801065f6:	50                   	push   %eax
801065f7:	68 ac 86 10 80       	push   $0x801086ac
801065fc:	e8 9f a0 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80106601:	e8 6a c3 ff ff       	call   80102970 <lapiceoi>
    break;
80106606:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106609:	e8 52 d4 ff ff       	call   80103a60 <myproc>
8010660e:	85 c0                	test   %eax,%eax
80106610:	0f 85 cd fe ff ff    	jne    801064e3 <trap+0x43>
80106616:	e9 e5 fe ff ff       	jmp    80106500 <trap+0x60>
8010661b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010661f:	90                   	nop
    if(myproc()->killed)
80106620:	e8 3b d4 ff ff       	call   80103a60 <myproc>
80106625:	8b 70 24             	mov    0x24(%eax),%esi
80106628:	85 f6                	test   %esi,%esi
8010662a:	0f 85 c8 00 00 00    	jne    801066f8 <trap+0x258>
    myproc()->tf = tf;
80106630:	e8 2b d4 ff ff       	call   80103a60 <myproc>
80106635:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80106638:	e8 93 ef ff ff       	call   801055d0 <syscall>
    if(myproc()->killed)
8010663d:	e8 1e d4 ff ff       	call   80103a60 <myproc>
80106642:	8b 48 24             	mov    0x24(%eax),%ecx
80106645:	85 c9                	test   %ecx,%ecx
80106647:	0f 84 f1 fe ff ff    	je     8010653e <trap+0x9e>
}
8010664d:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106650:	5b                   	pop    %ebx
80106651:	5e                   	pop    %esi
80106652:	5f                   	pop    %edi
80106653:	5d                   	pop    %ebp
      exit();
80106654:	e9 77 da ff ff       	jmp    801040d0 <exit>
80106659:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80106660:	e8 3b 02 00 00       	call   801068a0 <uartintr>
    lapiceoi();
80106665:	e8 06 c3 ff ff       	call   80102970 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010666a:	e8 f1 d3 ff ff       	call   80103a60 <myproc>
8010666f:	85 c0                	test   %eax,%eax
80106671:	0f 85 6c fe ff ff    	jne    801064e3 <trap+0x43>
80106677:	e9 84 fe ff ff       	jmp    80106500 <trap+0x60>
8010667c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80106680:	e8 ab c1 ff ff       	call   80102830 <kbdintr>
    lapiceoi();
80106685:	e8 e6 c2 ff ff       	call   80102970 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010668a:	e8 d1 d3 ff ff       	call   80103a60 <myproc>
8010668f:	85 c0                	test   %eax,%eax
80106691:	0f 85 4c fe ff ff    	jne    801064e3 <trap+0x43>
80106697:	e9 64 fe ff ff       	jmp    80106500 <trap+0x60>
8010669c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
801066a0:	e8 9b d3 ff ff       	call   80103a40 <cpuid>
801066a5:	85 c0                	test   %eax,%eax
801066a7:	0f 85 28 fe ff ff    	jne    801064d5 <trap+0x35>
      acquire(&tickslock);
801066ad:	83 ec 0c             	sub    $0xc,%esp
801066b0:	68 a0 5b 11 80       	push   $0x80115ba0
801066b5:	e8 56 ea ff ff       	call   80105110 <acquire>
      wakeup(&ticks);
801066ba:	c7 04 24 80 5b 11 80 	movl   $0x80115b80,(%esp)
      ticks++;
801066c1:	83 05 80 5b 11 80 01 	addl   $0x1,0x80115b80
      wakeup(&ticks);
801066c8:	e8 03 de ff ff       	call   801044d0 <wakeup>
      release(&tickslock);
801066cd:	c7 04 24 a0 5b 11 80 	movl   $0x80115ba0,(%esp)
801066d4:	e8 d7 e9 ff ff       	call   801050b0 <release>
801066d9:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
801066dc:	e9 f4 fd ff ff       	jmp    801064d5 <trap+0x35>
801066e1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
801066e8:	e8 e3 d9 ff ff       	call   801040d0 <exit>
801066ed:	e9 0e fe ff ff       	jmp    80106500 <trap+0x60>
801066f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
801066f8:	e8 d3 d9 ff ff       	call   801040d0 <exit>
801066fd:	e9 2e ff ff ff       	jmp    80106630 <trap+0x190>
80106702:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106705:	e8 36 d3 ff ff       	call   80103a40 <cpuid>
8010670a:	83 ec 0c             	sub    $0xc,%esp
8010670d:	56                   	push   %esi
8010670e:	57                   	push   %edi
8010670f:	50                   	push   %eax
80106710:	ff 73 30             	push   0x30(%ebx)
80106713:	68 d0 86 10 80       	push   $0x801086d0
80106718:	e8 83 9f ff ff       	call   801006a0 <cprintf>
      panic("trap");
8010671d:	83 c4 14             	add    $0x14,%esp
80106720:	68 a5 86 10 80       	push   $0x801086a5
80106725:	e8 56 9c ff ff       	call   80100380 <panic>
...
{
  if(!uart)
80106730:	a1 e0 63 11 80       	mov    0x801163e0,%eax
80106735:	85 c0                	test   %eax,%eax
80106737:	74 17                	je     80106750 <uartgetc+0x20>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106739:	ba fd 03 00 00       	mov    $0x3fd,%edx
8010673e:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
8010673f:	a8 01                	test   $0x1,%al
80106741:	74 0d                	je     80106750 <uartgetc+0x20>
80106743:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106748:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80106749:	0f b6 c0             	movzbl %al,%eax
8010674c:	c3                   	ret    
...
80106755:	c3                   	ret    
80106756:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80106763:	89 c8                	mov    %ecx,%eax
80106765:	89 e5                	mov    %esp,%ebp
80106767:	57                   	push   %edi
80106768:	bf fa 03 00 00       	mov    $0x3fa,%edi
8010676d:	56                   	push   %esi
8010676e:	89 fa                	mov    %edi,%edx
80106770:	53                   	push   %ebx
80106771:	83 ec 1c             	sub    $0x1c,%esp
80106774:	ee                   	out    %al,(%dx)
80106775:	be fb 03 00 00       	mov    $0x3fb,%esi
8010677a:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
8010677f:	89 f2                	mov    %esi,%edx
80106781:	ee                   	out    %al,(%dx)
80106782:	b8 0c 00 00 00       	mov    $0xc,%eax
80106787:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010678c:	ee                   	out    %al,(%dx)
8010678d:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80106792:	89 c8                	mov    %ecx,%eax
80106794:	89 da                	mov    %ebx,%edx
80106796:	ee                   	out    %al,(%dx)
80106797:	b8 03 00 00 00       	mov    $0x3,%eax
8010679c:	89 f2                	mov    %esi,%edx
8010679e:	ee                   	out    %al,(%dx)
8010679f:	ba fc 03 00 00       	mov    $0x3fc,%edx
801067a4:	89 c8                	mov    %ecx,%eax
801067a6:	ee                   	out    %al,(%dx)
801067a7:	b8 01 00 00 00       	mov    $0x1,%eax
801067ac:	89 da                	mov    %ebx,%edx
801067ae:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801067af:	ba fd 03 00 00       	mov    $0x3fd,%edx
801067b4:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
801067b5:	3c ff                	cmp    $0xff,%al
801067b7:	74 78                	je     80106831 <uartinit+0xd1>
  uart = 1;
801067b9:	c7 05 e0 63 11 80 01 	movl   $0x1,0x801163e0
801067c0:	00 00 00 
801067c3:	89 fa                	mov    %edi,%edx
801067c5:	ec                   	in     (%dx),%al
801067c6:	ba f8 03 00 00       	mov    $0x3f8,%edx
801067cb:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
801067cc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
801067cf:	bf c8 87 10 80       	mov    $0x801087c8,%edi
801067d4:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
801067d9:	6a 00                	push   $0x0
801067db:	6a 04                	push   $0x4
801067dd:	e8 fe bc ff ff       	call   801024e0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
801067e2:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
801067e6:	83 c4 10             	add    $0x10,%esp
801067e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
801067f0:	a1 e0 63 11 80       	mov    0x801163e0,%eax
801067f5:	bb 80 00 00 00       	mov    $0x80,%ebx
801067fa:	85 c0                	test   %eax,%eax
801067fc:	75 14                	jne    80106812 <uartinit+0xb2>
801067fe:	eb 23                	jmp    80106823 <uartinit+0xc3>
    microdelay(10);
80106800:	83 ec 0c             	sub    $0xc,%esp
80106803:	6a 0a                	push   $0xa
80106805:	e8 86 c1 ff ff       	call   80102990 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010680a:	83 c4 10             	add    $0x10,%esp
8010680d:	83 eb 01             	sub    $0x1,%ebx
80106810:	74 07                	je     80106819 <uartinit+0xb9>
80106812:	89 f2                	mov    %esi,%edx
80106814:	ec                   	in     (%dx),%al
80106815:	a8 20                	test   $0x20,%al
80106817:	74 e7                	je     80106800 <uartinit+0xa0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106819:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
8010681d:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106822:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80106823:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80106827:	83 c7 01             	add    $0x1,%edi
8010682a:	88 45 e7             	mov    %al,-0x19(%ebp)
8010682d:	84 c0                	test   %al,%al
8010682f:	75 bf                	jne    801067f0 <uartinit+0x90>
}
...
80106840 <uartputc>:
  if(!uart)
80106840:	a1 e0 63 11 80       	mov    0x801163e0,%eax
80106845:	85 c0                	test   %eax,%eax
80106847:	74 47                	je     80106890 <uartputc+0x50>
{
80106849:	55                   	push   %ebp
8010684a:	89 e5                	mov    %esp,%ebp
8010684c:	56                   	push   %esi
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010684d:	be fd 03 00 00       	mov    $0x3fd,%esi
80106852:	53                   	push   %ebx
80106853:	bb 80 00 00 00       	mov    $0x80,%ebx
80106858:	eb 18                	jmp    80106872 <uartputc+0x32>
8010685a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    microdelay(10);
80106860:	83 ec 0c             	sub    $0xc,%esp
80106863:	6a 0a                	push   $0xa
80106865:	e8 26 c1 ff ff       	call   80102990 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010686a:	83 c4 10             	add    $0x10,%esp
8010686d:	83 eb 01             	sub    $0x1,%ebx
80106870:	74 07                	je     80106879 <uartputc+0x39>
80106872:	89 f2                	mov    %esi,%edx
80106874:	ec                   	in     (%dx),%al
80106875:	a8 20                	test   $0x20,%al
80106877:	74 e7                	je     80106860 <uartputc+0x20>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106879:	8b 45 08             	mov    0x8(%ebp),%eax
8010687c:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106881:	ee                   	out    %al,(%dx)
}
80106882:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106885:	5b                   	pop    %ebx
80106886:	5e                   	pop    %esi
80106887:	5d                   	pop    %ebp
80106888:	c3                   	ret    
...
801068a6:	68 30 67 10 80       	push   $0x80106730
801068ab:	e8 d0 9f ff ff       	call   80100880 <consoleintr>
}
...
801068b7:	6a 00                	push   $0x0
  jmp alltraps
801068b9:	e9 01 fb ff ff       	jmp    801063bf <alltraps>
...
801068be:	6a 00                	push   $0x0
  pushl $1
801068c0:	6a 01                	push   $0x1
  jmp alltraps
801068c2:	e9 f8 fa ff ff       	jmp    801063bf <alltraps>
...
801068c7:	6a 00                	push   $0x0
  pushl $2
801068c9:	6a 02                	push   $0x2
  jmp alltraps
801068cb:	e9 ef fa ff ff       	jmp    801063bf <alltraps>
...
801068d0:	6a 00                	push   $0x0
  pushl $3
801068d2:	6a 03                	push   $0x3
  jmp alltraps
801068d4:	e9 e6 fa ff ff       	jmp    801063bf <alltraps>
...
801068db:	6a 04                	push   $0x4
  jmp alltraps
801068dd:	e9 dd fa ff ff       	jmp    801063bf <alltraps>
...
801068e2:	6a 00                	push   $0x0
  pushl $5
801068e4:	6a 05                	push   $0x5
  jmp alltraps
801068e6:	e9 d4 fa ff ff       	jmp    801063bf <alltraps>
...
801068eb:	6a 00                	push   $0x0
  pushl $6
801068ed:	6a 06                	push   $0x6
  jmp alltraps
801068ef:	e9 cb fa ff ff       	jmp    801063bf <alltraps>
...
801068f4:	6a 00                	push   $0x0
  pushl $7
801068f6:	6a 07                	push   $0x7
  jmp alltraps
801068f8:	e9 c2 fa ff ff       	jmp    801063bf <alltraps>

801068fd <vector8>:
.globl vector8
vector8:
  pushl $8
801068fd:	6a 08                	push   $0x8
  jmp alltraps
801068ff:	e9 bb fa ff ff       	jmp    801063bf <alltraps>
...
80106904:	6a 00                	push   $0x0
  pushl $9
80106906:	6a 09                	push   $0x9
  jmp alltraps
80106908:	e9 b2 fa ff ff       	jmp    801063bf <alltraps>

8010690d <vector10>:
.globl vector10
vector10:
  pushl $10
8010690d:	6a 0a                	push   $0xa
  jmp alltraps
8010690f:	e9 ab fa ff ff       	jmp    801063bf <alltraps>

80106914 <vector11>:
.globl vector11
vector11:
  pushl $11
80106914:	6a 0b                	push   $0xb
  jmp alltraps
80106916:	e9 a4 fa ff ff       	jmp    801063bf <alltraps>
...
8010691b:	6a 0c                	push   $0xc
  jmp alltraps
8010691d:	e9 9d fa ff ff       	jmp    801063bf <alltraps>

80106922 <vector13>:
.globl vector13
vector13:
  pushl $13
80106922:	6a 0d                	push   $0xd
  jmp alltraps
80106924:	e9 96 fa ff ff       	jmp    801063bf <alltraps>

80106929 <vector14>:
.globl vector14
vector14:
  pushl $14
80106929:	6a 0e                	push   $0xe
  jmp alltraps
8010692b:	e9 8f fa ff ff       	jmp    801063bf <alltraps>
...
80106930:	6a 00                	push   $0x0
  pushl $15
80106932:	6a 0f                	push   $0xf
  jmp alltraps
80106934:	e9 86 fa ff ff       	jmp    801063bf <alltraps>
...
80106939:	6a 00                	push   $0x0
  pushl $16
8010693b:	6a 10                	push   $0x10
  jmp alltraps
8010693d:	e9 7d fa ff ff       	jmp    801063bf <alltraps>

80106942 <vector17>:
.globl vector17
vector17:
  pushl $17
80106942:	6a 11                	push   $0x11
  jmp alltraps
80106944:	e9 76 fa ff ff       	jmp    801063bf <alltraps>
...
80106949:	6a 00                	push   $0x0
  pushl $18
8010694b:	6a 12                	push   $0x12
  jmp alltraps
8010694d:	e9 6d fa ff ff       	jmp    801063bf <alltraps>
...
80106952:	6a 00                	push   $0x0
  pushl $19
80106954:	6a 13                	push   $0x13
  jmp alltraps
80106956:	e9 64 fa ff ff       	jmp    801063bf <alltraps>
...
8010695b:	6a 00                	push   $0x0
  pushl $20
8010695d:	6a 14                	push   $0x14
  jmp alltraps
8010695f:	e9 5b fa ff ff       	jmp    801063bf <alltraps>
...
80106964:	6a 00                	push   $0x0
  pushl $21
80106966:	6a 15                	push   $0x15
  jmp alltraps
80106968:	e9 52 fa ff ff       	jmp    801063bf <alltraps>
...
8010696d:	6a 00                	push   $0x0
  pushl $22
8010696f:	6a 16                	push   $0x16
  jmp alltraps
80106971:	e9 49 fa ff ff       	jmp    801063bf <alltraps>
...
80106976:	6a 00                	push   $0x0
  pushl $23
80106978:	6a 17                	push   $0x17
  jmp alltraps
8010697a:	e9 40 fa ff ff       	jmp    801063bf <alltraps>
...
8010697f:	6a 00                	push   $0x0
  pushl $24
80106981:	6a 18                	push   $0x18
  jmp alltraps
80106983:	e9 37 fa ff ff       	jmp    801063bf <alltraps>
...
80106988:	6a 00                	push   $0x0
  pushl $25
8010698a:	6a 19                	push   $0x19
  jmp alltraps
8010698c:	e9 2e fa ff ff       	jmp    801063bf <alltraps>
...
80106991:	6a 00                	push   $0x0
  pushl $26
80106993:	6a 1a                	push   $0x1a
  jmp alltraps
80106995:	e9 25 fa ff ff       	jmp    801063bf <alltraps>
...
8010699a:	6a 00                	push   $0x0
  pushl $27
8010699c:	6a 1b                	push   $0x1b
  jmp alltraps
8010699e:	e9 1c fa ff ff       	jmp    801063bf <alltraps>
...
801069a3:	6a 00                	push   $0x0
  pushl $28
801069a5:	6a 1c                	push   $0x1c
  jmp alltraps
801069a7:	e9 13 fa ff ff       	jmp    801063bf <alltraps>
...
801069ac:	6a 00                	push   $0x0
  pushl $29
801069ae:	6a 1d                	push   $0x1d
  jmp alltraps
801069b0:	e9 0a fa ff ff       	jmp    801063bf <alltraps>
...
801069b5:	6a 00                	push   $0x0
  pushl $30
801069b7:	6a 1e                	push   $0x1e
  jmp alltraps
801069b9:	e9 01 fa ff ff       	jmp    801063bf <alltraps>
...
801069be:	6a 00                	push   $0x0
  pushl $31
801069c0:	6a 1f                	push   $0x1f
  jmp alltraps
801069c2:	e9 f8 f9 ff ff       	jmp    801063bf <alltraps>
...
801069c7:	6a 00                	push   $0x0
  pushl $32
801069c9:	6a 20                	push   $0x20
  jmp alltraps
801069cb:	e9 ef f9 ff ff       	jmp    801063bf <alltraps>
...
801069d0:	6a 00                	push   $0x0
  pushl $33
801069d2:	6a 21                	push   $0x21
  jmp alltraps
801069d4:	e9 e6 f9 ff ff       	jmp    801063bf <alltraps>
...
801069d9:	6a 00                	push   $0x0
  pushl $34
801069db:	6a 22                	push   $0x22
  jmp alltraps
801069dd:	e9 dd f9 ff ff       	jmp    801063bf <alltraps>
...
801069e2:	6a 00                	push   $0x0
  pushl $35
801069e4:	6a 23                	push   $0x23
  jmp alltraps
801069e6:	e9 d4 f9 ff ff       	jmp    801063bf <alltraps>
...
801069eb:	6a 00                	push   $0x0
  pushl $36
801069ed:	6a 24                	push   $0x24
  jmp alltraps
801069ef:	e9 cb f9 ff ff       	jmp    801063bf <alltraps>
...
801069f4:	6a 00                	push   $0x0
  pushl $37
801069f6:	6a 25                	push   $0x25
  jmp alltraps
801069f8:	e9 c2 f9 ff ff       	jmp    801063bf <alltraps>
...
801069fd:	6a 00                	push   $0x0
  pushl $38
801069ff:	6a 26                	push   $0x26
  jmp alltraps
80106a01:	e9 b9 f9 ff ff       	jmp    801063bf <alltraps>
...
80106a06:	6a 00                	push   $0x0
  pushl $39
80106a08:	6a 27                	push   $0x27
  jmp alltraps
80106a0a:	e9 b0 f9 ff ff       	jmp    801063bf <alltraps>
...
80106a0f:	6a 00                	push   $0x0
  pushl $40
80106a11:	6a 28                	push   $0x28
  jmp alltraps
80106a13:	e9 a7 f9 ff ff       	jmp    801063bf <alltraps>
...
80106a18:	6a 00                	push   $0x0
  pushl $41
80106a1a:	6a 29                	push   $0x29
  jmp alltraps
80106a1c:	e9 9e f9 ff ff       	jmp    801063bf <alltraps>
...
80106a21:	6a 00                	push   $0x0
  pushl $42
80106a23:	6a 2a                	push   $0x2a
  jmp alltraps
80106a25:	e9 95 f9 ff ff       	jmp    801063bf <alltraps>
...
80106a2a:	6a 00                	push   $0x0
  pushl $43
80106a2c:	6a 2b                	push   $0x2b
  jmp alltraps
80106a2e:	e9 8c f9 ff ff       	jmp    801063bf <alltraps>
...
80106a33:	6a 00                	push   $0x0
  pushl $44
80106a35:	6a 2c                	push   $0x2c
  jmp alltraps
80106a37:	e9 83 f9 ff ff       	jmp    801063bf <alltraps>
...
80106a3c:	6a 00                	push   $0x0
  pushl $45
80106a3e:	6a 2d                	push   $0x2d
  jmp alltraps
80106a40:	e9 7a f9 ff ff       	jmp    801063bf <alltraps>
...
80106a45:	6a 00                	push   $0x0
  pushl $46
80106a47:	6a 2e                	push   $0x2e
  jmp alltraps
80106a49:	e9 71 f9 ff ff       	jmp    801063bf <alltraps>
...
80106a4e:	6a 00                	push   $0x0
  pushl $47
80106a50:	6a 2f                	push   $0x2f
  jmp alltraps
80106a52:	e9 68 f9 ff ff       	jmp    801063bf <alltraps>
...
80106a57:	6a 00                	push   $0x0
  pushl $48
80106a59:	6a 30                	push   $0x30
  jmp alltraps
80106a5b:	e9 5f f9 ff ff       	jmp    801063bf <alltraps>
...
80106a60:	6a 00                	push   $0x0
  pushl $49
80106a62:	6a 31                	push   $0x31
  jmp alltraps
80106a64:	e9 56 f9 ff ff       	jmp    801063bf <alltraps>
...
80106a69:	6a 00                	push   $0x0
  pushl $50
80106a6b:	6a 32                	push   $0x32
  jmp alltraps
80106a6d:	e9 4d f9 ff ff       	jmp    801063bf <alltraps>
...
80106a72:	6a 00                	push   $0x0
  pushl $51
80106a74:	6a 33                	push   $0x33
  jmp alltraps
80106a76:	e9 44 f9 ff ff       	jmp    801063bf <alltraps>
...
80106a7b:	6a 00                	push   $0x0
  pushl $52
80106a7d:	6a 34                	push   $0x34
  jmp alltraps
80106a7f:	e9 3b f9 ff ff       	jmp    801063bf <alltraps>
...
80106a84:	6a 00                	push   $0x0
  pushl $53
80106a86:	6a 35                	push   $0x35
  jmp alltraps
80106a88:	e9 32 f9 ff ff       	jmp    801063bf <alltraps>
...
80106a8d:	6a 00                	push   $0x0
  pushl $54
80106a8f:	6a 36                	push   $0x36
  jmp alltraps
80106a91:	e9 29 f9 ff ff       	jmp    801063bf <alltraps>
...
80106a96:	6a 00                	push   $0x0
  pushl $55
80106a98:	6a 37                	push   $0x37
  jmp alltraps
80106a9a:	e9 20 f9 ff ff       	jmp    801063bf <alltraps>
...
80106a9f:	6a 00                	push   $0x0
  pushl $56
80106aa1:	6a 38                	push   $0x38
  jmp alltraps
80106aa3:	e9 17 f9 ff ff       	jmp    801063bf <alltraps>
...
80106aa8:	6a 00                	push   $0x0
  pushl $57
80106aaa:	6a 39                	push   $0x39
  jmp alltraps
80106aac:	e9 0e f9 ff ff       	jmp    801063bf <alltraps>
...
80106ab1:	6a 00                	push   $0x0
  pushl $58
80106ab3:	6a 3a                	push   $0x3a
  jmp alltraps
80106ab5:	e9 05 f9 ff ff       	jmp    801063bf <alltraps>
...
80106aba:	6a 00                	push   $0x0
  pushl $59
80106abc:	6a 3b                	push   $0x3b
  jmp alltraps
80106abe:	e9 fc f8 ff ff       	jmp    801063bf <alltraps>
...
80106ac3:	6a 00                	push   $0x0
  pushl $60
80106ac5:	6a 3c                	push   $0x3c
  jmp alltraps
80106ac7:	e9 f3 f8 ff ff       	jmp    801063bf <alltraps>
...
80106acc:	6a 00                	push   $0x0
  pushl $61
80106ace:	6a 3d                	push   $0x3d
  jmp alltraps
80106ad0:	e9 ea f8 ff ff       	jmp    801063bf <alltraps>
...
80106ad5:	6a 00                	push   $0x0
  pushl $62
80106ad7:	6a 3e                	push   $0x3e
  jmp alltraps
80106ad9:	e9 e1 f8 ff ff       	jmp    801063bf <alltraps>
...
80106ade:	6a 00                	push   $0x0
  pushl $63
80106ae0:	6a 3f                	push   $0x3f
  jmp alltraps
80106ae2:	e9 d8 f8 ff ff       	jmp    801063bf <alltraps>
...
80106ae7:	6a 00                	push   $0x0
  pushl $64
80106ae9:	6a 40                	push   $0x40
  jmp alltraps
80106aeb:	e9 cf f8 ff ff       	jmp    801063bf <alltraps>
...
80106af0:	6a 00                	push   $0x0
  pushl $65
80106af2:	6a 41                	push   $0x41
  jmp alltraps
80106af4:	e9 c6 f8 ff ff       	jmp    801063bf <alltraps>
...
80106af9:	6a 00                	push   $0x0
  pushl $66
80106afb:	6a 42                	push   $0x42
  jmp alltraps
80106afd:	e9 bd f8 ff ff       	jmp    801063bf <alltraps>
...
80106b02:	6a 00                	push   $0x0
  pushl $67
80106b04:	6a 43                	push   $0x43
  jmp alltraps
80106b06:	e9 b4 f8 ff ff       	jmp    801063bf <alltraps>
...
80106b0b:	6a 00                	push   $0x0
  pushl $68
80106b0d:	6a 44                	push   $0x44
  jmp alltraps
80106b0f:	e9 ab f8 ff ff       	jmp    801063bf <alltraps>
...
80106b14:	6a 00                	push   $0x0
  pushl $69
80106b16:	6a 45                	push   $0x45
  jmp alltraps
80106b18:	e9 a2 f8 ff ff       	jmp    801063bf <alltraps>
...
80106b1d:	6a 00                	push   $0x0
  pushl $70
80106b1f:	6a 46                	push   $0x46
  jmp alltraps
80106b21:	e9 99 f8 ff ff       	jmp    801063bf <alltraps>
...
80106b26:	6a 00                	push   $0x0
  pushl $71
80106b28:	6a 47                	push   $0x47
  jmp alltraps
80106b2a:	e9 90 f8 ff ff       	jmp    801063bf <alltraps>
...
80106b2f:	6a 00                	push   $0x0
  pushl $72
80106b31:	6a 48                	push   $0x48
  jmp alltraps
80106b33:	e9 87 f8 ff ff       	jmp    801063bf <alltraps>
...
80106b38:	6a 00                	push   $0x0
  pushl $73
80106b3a:	6a 49                	push   $0x49
  jmp alltraps
80106b3c:	e9 7e f8 ff ff       	jmp    801063bf <alltraps>
...
80106b41:	6a 00                	push   $0x0
  pushl $74
80106b43:	6a 4a                	push   $0x4a
  jmp alltraps
80106b45:	e9 75 f8 ff ff       	jmp    801063bf <alltraps>
...
80106b4a:	6a 00                	push   $0x0
  pushl $75
80106b4c:	6a 4b                	push   $0x4b
  jmp alltraps
80106b4e:	e9 6c f8 ff ff       	jmp    801063bf <alltraps>
...
80106b53:	6a 00                	push   $0x0
  pushl $76
80106b55:	6a 4c                	push   $0x4c
  jmp alltraps
80106b57:	e9 63 f8 ff ff       	jmp    801063bf <alltraps>
...
80106b5c:	6a 00                	push   $0x0
  pushl $77
80106b5e:	6a 4d                	push   $0x4d
  jmp alltraps
80106b60:	e9 5a f8 ff ff       	jmp    801063bf <alltraps>
...
80106b65:	6a 00                	push   $0x0
  pushl $78
80106b67:	6a 4e                	push   $0x4e
  jmp alltraps
80106b69:	e9 51 f8 ff ff       	jmp    801063bf <alltraps>
...
80106b6e:	6a 00                	push   $0x0
  pushl $79
80106b70:	6a 4f                	push   $0x4f
  jmp alltraps
80106b72:	e9 48 f8 ff ff       	jmp    801063bf <alltraps>
...
80106b77:	6a 00                	push   $0x0
  pushl $80
80106b79:	6a 50                	push   $0x50
  jmp alltraps
80106b7b:	e9 3f f8 ff ff       	jmp    801063bf <alltraps>
...
80106b80:	6a 00                	push   $0x0
  pushl $81
80106b82:	6a 51                	push   $0x51
  jmp alltraps
80106b84:	e9 36 f8 ff ff       	jmp    801063bf <alltraps>
...
80106b89:	6a 00                	push   $0x0
  pushl $82
80106b8b:	6a 52                	push   $0x52
  jmp alltraps
80106b8d:	e9 2d f8 ff ff       	jmp    801063bf <alltraps>
...
80106b92:	6a 00                	push   $0x0
  pushl $83
80106b94:	6a 53                	push   $0x53
  jmp alltraps
80106b96:	e9 24 f8 ff ff       	jmp    801063bf <alltraps>
...
80106b9b:	6a 00                	push   $0x0
  pushl $84
80106b9d:	6a 54                	push   $0x54
  jmp alltraps
80106b9f:	e9 1b f8 ff ff       	jmp    801063bf <alltraps>
...
80106ba4:	6a 00                	push   $0x0
  pushl $85
80106ba6:	6a 55                	push   $0x55
  jmp alltraps
80106ba8:	e9 12 f8 ff ff       	jmp    801063bf <alltraps>
...
80106bad:	6a 00                	push   $0x0
  pushl $86
80106baf:	6a 56                	push   $0x56
  jmp alltraps
80106bb1:	e9 09 f8 ff ff       	jmp    801063bf <alltraps>
...
80106bb6:	6a 00                	push   $0x0
  pushl $87
80106bb8:	6a 57                	push   $0x57
  jmp alltraps
80106bba:	e9 00 f8 ff ff       	jmp    801063bf <alltraps>
...
80106bbf:	6a 00                	push   $0x0
  pushl $88
80106bc1:	6a 58                	push   $0x58
  jmp alltraps
80106bc3:	e9 f7 f7 ff ff       	jmp    801063bf <alltraps>
...
80106bc8:	6a 00                	push   $0x0
  pushl $89
80106bca:	6a 59                	push   $0x59
  jmp alltraps
80106bcc:	e9 ee f7 ff ff       	jmp    801063bf <alltraps>
...
80106bd1:	6a 00                	push   $0x0
  pushl $90
80106bd3:	6a 5a                	push   $0x5a
  jmp alltraps
80106bd5:	e9 e5 f7 ff ff       	jmp    801063bf <alltraps>
...
80106bda:	6a 00                	push   $0x0
  pushl $91
80106bdc:	6a 5b                	push   $0x5b
  jmp alltraps
80106bde:	e9 dc f7 ff ff       	jmp    801063bf <alltraps>
...
80106be3:	6a 00                	push   $0x0
  pushl $92
80106be5:	6a 5c                	push   $0x5c
  jmp alltraps
80106be7:	e9 d3 f7 ff ff       	jmp    801063bf <alltraps>
...
80106bec:	6a 00                	push   $0x0
  pushl $93
80106bee:	6a 5d                	push   $0x5d
  jmp alltraps
80106bf0:	e9 ca f7 ff ff       	jmp    801063bf <alltraps>
...
80106bf5:	6a 00                	push   $0x0
  pushl $94
80106bf7:	6a 5e                	push   $0x5e
  jmp alltraps
80106bf9:	e9 c1 f7 ff ff       	jmp    801063bf <alltraps>
...
80106bfe:	6a 00                	push   $0x0
  pushl $95
80106c00:	6a 5f                	push   $0x5f
  jmp alltraps
80106c02:	e9 b8 f7 ff ff       	jmp    801063bf <alltraps>
...
80106c07:	6a 00                	push   $0x0
  pushl $96
80106c09:	6a 60                	push   $0x60
  jmp alltraps
80106c0b:	e9 af f7 ff ff       	jmp    801063bf <alltraps>
...
80106c10:	6a 00                	push   $0x0
  pushl $97
80106c12:	6a 61                	push   $0x61
  jmp alltraps
80106c14:	e9 a6 f7 ff ff       	jmp    801063bf <alltraps>
...
80106c19:	6a 00                	push   $0x0
  pushl $98
80106c1b:	6a 62                	push   $0x62
  jmp alltraps
80106c1d:	e9 9d f7 ff ff       	jmp    801063bf <alltraps>
...
80106c22:	6a 00                	push   $0x0
  pushl $99
80106c24:	6a 63                	push   $0x63
  jmp alltraps
80106c26:	e9 94 f7 ff ff       	jmp    801063bf <alltraps>
...
80106c2b:	6a 00                	push   $0x0
  pushl $100
80106c2d:	6a 64                	push   $0x64
  jmp alltraps
80106c2f:	e9 8b f7 ff ff       	jmp    801063bf <alltraps>
...
80106c34:	6a 00                	push   $0x0
  pushl $101
80106c36:	6a 65                	push   $0x65
  jmp alltraps
80106c38:	e9 82 f7 ff ff       	jmp    801063bf <alltraps>
...
80106c3d:	6a 00                	push   $0x0
  pushl $102
80106c3f:	6a 66                	push   $0x66
  jmp alltraps
80106c41:	e9 79 f7 ff ff       	jmp    801063bf <alltraps>
...
80106c46:	6a 00                	push   $0x0
  pushl $103
80106c48:	6a 67                	push   $0x67
  jmp alltraps
80106c4a:	e9 70 f7 ff ff       	jmp    801063bf <alltraps>
...
80106c4f:	6a 00                	push   $0x0
  pushl $104
80106c51:	6a 68                	push   $0x68
  jmp alltraps
80106c53:	e9 67 f7 ff ff       	jmp    801063bf <alltraps>
...
80106c58:	6a 00                	push   $0x0
  pushl $105
80106c5a:	6a 69                	push   $0x69
  jmp alltraps
80106c5c:	e9 5e f7 ff ff       	jmp    801063bf <alltraps>
...
80106c61:	6a 00                	push   $0x0
  pushl $106
80106c63:	6a 6a                	push   $0x6a
  jmp alltraps
80106c65:	e9 55 f7 ff ff       	jmp    801063bf <alltraps>
...
80106c6a:	6a 00                	push   $0x0
  pushl $107
80106c6c:	6a 6b                	push   $0x6b
  jmp alltraps
80106c6e:	e9 4c f7 ff ff       	jmp    801063bf <alltraps>
...
80106c73:	6a 00                	push   $0x0
  pushl $108
80106c75:	6a 6c                	push   $0x6c
  jmp alltraps
80106c77:	e9 43 f7 ff ff       	jmp    801063bf <alltraps>
...
80106c7c:	6a 00                	push   $0x0
  pushl $109
80106c7e:	6a 6d                	push   $0x6d
  jmp alltraps
80106c80:	e9 3a f7 ff ff       	jmp    801063bf <alltraps>
...
80106c85:	6a 00                	push   $0x0
  pushl $110
80106c87:	6a 6e                	push   $0x6e
  jmp alltraps
80106c89:	e9 31 f7 ff ff       	jmp    801063bf <alltraps>
...
80106c8e:	6a 00                	push   $0x0
  pushl $111
80106c90:	6a 6f                	push   $0x6f
  jmp alltraps
80106c92:	e9 28 f7 ff ff       	jmp    801063bf <alltraps>
...
80106c97:	6a 00                	push   $0x0
  pushl $112
80106c99:	6a 70                	push   $0x70
  jmp alltraps
80106c9b:	e9 1f f7 ff ff       	jmp    801063bf <alltraps>
...
80106ca0:	6a 00                	push   $0x0
  pushl $113
80106ca2:	6a 71                	push   $0x71
  jmp alltraps
80106ca4:	e9 16 f7 ff ff       	jmp    801063bf <alltraps>
...
80106ca9:	6a 00                	push   $0x0
  pushl $114
80106cab:	6a 72                	push   $0x72
  jmp alltraps
80106cad:	e9 0d f7 ff ff       	jmp    801063bf <alltraps>
...
80106cb2:	6a 00                	push   $0x0
  pushl $115
80106cb4:	6a 73                	push   $0x73
  jmp alltraps
80106cb6:	e9 04 f7 ff ff       	jmp    801063bf <alltraps>
...
80106cbb:	6a 00                	push   $0x0
  pushl $116
80106cbd:	6a 74                	push   $0x74
  jmp alltraps
80106cbf:	e9 fb f6 ff ff       	jmp    801063bf <alltraps>
...
80106cc4:	6a 00                	push   $0x0
  pushl $117
80106cc6:	6a 75                	push   $0x75
  jmp alltraps
80106cc8:	e9 f2 f6 ff ff       	jmp    801063bf <alltraps>
...
80106ccd:	6a 00                	push   $0x0
  pushl $118
80106ccf:	6a 76                	push   $0x76
  jmp alltraps
80106cd1:	e9 e9 f6 ff ff       	jmp    801063bf <alltraps>
...
80106cd6:	6a 00                	push   $0x0
  pushl $119
80106cd8:	6a 77                	push   $0x77
  jmp alltraps
80106cda:	e9 e0 f6 ff ff       	jmp    801063bf <alltraps>
...
80106cdf:	6a 00                	push   $0x0
  pushl $120
80106ce1:	6a 78                	push   $0x78
  jmp alltraps
80106ce3:	e9 d7 f6 ff ff       	jmp    801063bf <alltraps>
...
80106ce8:	6a 00                	push   $0x0
  pushl $121
80106cea:	6a 79                	push   $0x79
  jmp alltraps
80106cec:	e9 ce f6 ff ff       	jmp    801063bf <alltraps>
...
80106cf1:	6a 00                	push   $0x0
  pushl $122
80106cf3:	6a 7a                	push   $0x7a
  jmp alltraps
80106cf5:	e9 c5 f6 ff ff       	jmp    801063bf <alltraps>
...
80106cfa:	6a 00                	push   $0x0
  pushl $123
80106cfc:	6a 7b                	push   $0x7b
  jmp alltraps
80106cfe:	e9 bc f6 ff ff       	jmp    801063bf <alltraps>
...
80106d03:	6a 00                	push   $0x0
  pushl $124
80106d05:	6a 7c                	push   $0x7c
  jmp alltraps
80106d07:	e9 b3 f6 ff ff       	jmp    801063bf <alltraps>
...
80106d0c:	6a 00                	push   $0x0
  pushl $125
80106d0e:	6a 7d                	push   $0x7d
  jmp alltraps
80106d10:	e9 aa f6 ff ff       	jmp    801063bf <alltraps>
...
80106d15:	6a 00                	push   $0x0
  pushl $126
80106d17:	6a 7e                	push   $0x7e
  jmp alltraps
80106d19:	e9 a1 f6 ff ff       	jmp    801063bf <alltraps>
...
80106d1e:	6a 00                	push   $0x0
  pushl $127
80106d20:	6a 7f                	push   $0x7f
  jmp alltraps
80106d22:	e9 98 f6 ff ff       	jmp    801063bf <alltraps>
...
80106d27:	6a 00                	push   $0x0
  pushl $128
80106d29:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106d2e:	e9 8c f6 ff ff       	jmp    801063bf <alltraps>
...
80106d33:	6a 00                	push   $0x0
  pushl $129
80106d35:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106d3a:	e9 80 f6 ff ff       	jmp    801063bf <alltraps>
...
80106d3f:	6a 00                	push   $0x0
  pushl $130
80106d41:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106d46:	e9 74 f6 ff ff       	jmp    801063bf <alltraps>
...
80106d4b:	6a 00                	push   $0x0
  pushl $131
80106d4d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106d52:	e9 68 f6 ff ff       	jmp    801063bf <alltraps>
...
80106d57:	6a 00                	push   $0x0
  pushl $132
80106d59:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106d5e:	e9 5c f6 ff ff       	jmp    801063bf <alltraps>
...
80106d63:	6a 00                	push   $0x0
  pushl $133
80106d65:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106d6a:	e9 50 f6 ff ff       	jmp    801063bf <alltraps>
...
80106d6f:	6a 00                	push   $0x0
  pushl $134
80106d71:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106d76:	e9 44 f6 ff ff       	jmp    801063bf <alltraps>
...
80106d7b:	6a 00                	push   $0x0
  pushl $135
80106d7d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106d82:	e9 38 f6 ff ff       	jmp    801063bf <alltraps>
...
80106d87:	6a 00                	push   $0x0
  pushl $136
80106d89:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106d8e:	e9 2c f6 ff ff       	jmp    801063bf <alltraps>
...
80106d93:	6a 00                	push   $0x0
  pushl $137
80106d95:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106d9a:	e9 20 f6 ff ff       	jmp    801063bf <alltraps>
...
80106d9f:	6a 00                	push   $0x0
  pushl $138
80106da1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106da6:	e9 14 f6 ff ff       	jmp    801063bf <alltraps>
...
80106dab:	6a 00                	push   $0x0
  pushl $139
80106dad:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106db2:	e9 08 f6 ff ff       	jmp    801063bf <alltraps>
...
80106db7:	6a 00                	push   $0x0
  pushl $140
80106db9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106dbe:	e9 fc f5 ff ff       	jmp    801063bf <alltraps>
...
80106dc3:	6a 00                	push   $0x0
  pushl $141
80106dc5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106dca:	e9 f0 f5 ff ff       	jmp    801063bf <alltraps>
...
80106dcf:	6a 00                	push   $0x0
  pushl $142
80106dd1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106dd6:	e9 e4 f5 ff ff       	jmp    801063bf <alltraps>
...
80106ddb:	6a 00                	push   $0x0
  pushl $143
80106ddd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106de2:	e9 d8 f5 ff ff       	jmp    801063bf <alltraps>
...
80106de7:	6a 00                	push   $0x0
  pushl $144
80106de9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106dee:	e9 cc f5 ff ff       	jmp    801063bf <alltraps>
...
80106df3:	6a 00                	push   $0x0
  pushl $145
80106df5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106dfa:	e9 c0 f5 ff ff       	jmp    801063bf <alltraps>
...
80106dff:	6a 00                	push   $0x0
  pushl $146
80106e01:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106e06:	e9 b4 f5 ff ff       	jmp    801063bf <alltraps>
...
80106e0b:	6a 00                	push   $0x0
  pushl $147
80106e0d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106e12:	e9 a8 f5 ff ff       	jmp    801063bf <alltraps>
...
80106e17:	6a 00                	push   $0x0
  pushl $148
80106e19:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106e1e:	e9 9c f5 ff ff       	jmp    801063bf <alltraps>
...
80106e23:	6a 00                	push   $0x0
  pushl $149
80106e25:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106e2a:	e9 90 f5 ff ff       	jmp    801063bf <alltraps>
...
80106e2f:	6a 00                	push   $0x0
  pushl $150
80106e31:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106e36:	e9 84 f5 ff ff       	jmp    801063bf <alltraps>
...
80106e3b:	6a 00                	push   $0x0
  pushl $151
80106e3d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106e42:	e9 78 f5 ff ff       	jmp    801063bf <alltraps>
...
80106e47:	6a 00                	push   $0x0
  pushl $152
80106e49:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106e4e:	e9 6c f5 ff ff       	jmp    801063bf <alltraps>
...
80106e53:	6a 00                	push   $0x0
  pushl $153
80106e55:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106e5a:	e9 60 f5 ff ff       	jmp    801063bf <alltraps>
...
80106e5f:	6a 00                	push   $0x0
  pushl $154
80106e61:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106e66:	e9 54 f5 ff ff       	jmp    801063bf <alltraps>
...
80106e6b:	6a 00                	push   $0x0
  pushl $155
80106e6d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106e72:	e9 48 f5 ff ff       	jmp    801063bf <alltraps>
...
80106e77:	6a 00                	push   $0x0
  pushl $156
80106e79:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106e7e:	e9 3c f5 ff ff       	jmp    801063bf <alltraps>
...
80106e83:	6a 00                	push   $0x0
  pushl $157
80106e85:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106e8a:	e9 30 f5 ff ff       	jmp    801063bf <alltraps>
...
80106e8f:	6a 00                	push   $0x0
  pushl $158
80106e91:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106e96:	e9 24 f5 ff ff       	jmp    801063bf <alltraps>
...
80106e9b:	6a 00                	push   $0x0
  pushl $159
80106e9d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106ea2:	e9 18 f5 ff ff       	jmp    801063bf <alltraps>
...
80106ea7:	6a 00                	push   $0x0
  pushl $160
80106ea9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106eae:	e9 0c f5 ff ff       	jmp    801063bf <alltraps>
...
80106eb3:	6a 00                	push   $0x0
  pushl $161
80106eb5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106eba:	e9 00 f5 ff ff       	jmp    801063bf <alltraps>
...
80106ebf:	6a 00                	push   $0x0
  pushl $162
80106ec1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106ec6:	e9 f4 f4 ff ff       	jmp    801063bf <alltraps>
...
80106ecb:	6a 00                	push   $0x0
  pushl $163
80106ecd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106ed2:	e9 e8 f4 ff ff       	jmp    801063bf <alltraps>
...
80106ed7:	6a 00                	push   $0x0
  pushl $164
80106ed9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106ede:	e9 dc f4 ff ff       	jmp    801063bf <alltraps>
...
80106ee3:	6a 00                	push   $0x0
  pushl $165
80106ee5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106eea:	e9 d0 f4 ff ff       	jmp    801063bf <alltraps>
...
80106eef:	6a 00                	push   $0x0
  pushl $166
80106ef1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106ef6:	e9 c4 f4 ff ff       	jmp    801063bf <alltraps>
...
80106efb:	6a 00                	push   $0x0
  pushl $167
80106efd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106f02:	e9 b8 f4 ff ff       	jmp    801063bf <alltraps>
...
80106f07:	6a 00                	push   $0x0
  pushl $168
80106f09:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106f0e:	e9 ac f4 ff ff       	jmp    801063bf <alltraps>
...
80106f13:	6a 00                	push   $0x0
  pushl $169
80106f15:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106f1a:	e9 a0 f4 ff ff       	jmp    801063bf <alltraps>
...
80106f1f:	6a 00                	push   $0x0
  pushl $170
80106f21:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106f26:	e9 94 f4 ff ff       	jmp    801063bf <alltraps>
...
80106f2b:	6a 00                	push   $0x0
  pushl $171
80106f2d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106f32:	e9 88 f4 ff ff       	jmp    801063bf <alltraps>
...
80106f37:	6a 00                	push   $0x0
  pushl $172
80106f39:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106f3e:	e9 7c f4 ff ff       	jmp    801063bf <alltraps>
...
80106f43:	6a 00                	push   $0x0
  pushl $173
80106f45:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106f4a:	e9 70 f4 ff ff       	jmp    801063bf <alltraps>
...
80106f4f:	6a 00                	push   $0x0
  pushl $174
80106f51:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106f56:	e9 64 f4 ff ff       	jmp    801063bf <alltraps>
...
80106f5b:	6a 00                	push   $0x0
  pushl $175
80106f5d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106f62:	e9 58 f4 ff ff       	jmp    801063bf <alltraps>
...
80106f67:	6a 00                	push   $0x0
  pushl $176
80106f69:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106f6e:	e9 4c f4 ff ff       	jmp    801063bf <alltraps>
...
80106f73:	6a 00                	push   $0x0
  pushl $177
80106f75:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106f7a:	e9 40 f4 ff ff       	jmp    801063bf <alltraps>
...
80106f7f:	6a 00                	push   $0x0
  pushl $178
80106f81:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106f86:	e9 34 f4 ff ff       	jmp    801063bf <alltraps>
...
80106f8b:	6a 00                	push   $0x0
  pushl $179
80106f8d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106f92:	e9 28 f4 ff ff       	jmp    801063bf <alltraps>
...
80106f97:	6a 00                	push   $0x0
  pushl $180
80106f99:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106f9e:	e9 1c f4 ff ff       	jmp    801063bf <alltraps>
...
80106fa3:	6a 00                	push   $0x0
  pushl $181
80106fa5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106faa:	e9 10 f4 ff ff       	jmp    801063bf <alltraps>
...
80106faf:	6a 00                	push   $0x0
  pushl $182
80106fb1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106fb6:	e9 04 f4 ff ff       	jmp    801063bf <alltraps>
...
80106fbb:	6a 00                	push   $0x0
  pushl $183
80106fbd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106fc2:	e9 f8 f3 ff ff       	jmp    801063bf <alltraps>
...
80106fc7:	6a 00                	push   $0x0
  pushl $184
80106fc9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106fce:	e9 ec f3 ff ff       	jmp    801063bf <alltraps>
...
80106fd3:	6a 00                	push   $0x0
  pushl $185
80106fd5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106fda:	e9 e0 f3 ff ff       	jmp    801063bf <alltraps>
...
80106fdf:	6a 00                	push   $0x0
  pushl $186
80106fe1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106fe6:	e9 d4 f3 ff ff       	jmp    801063bf <alltraps>
...
80106feb:	6a 00                	push   $0x0
  pushl $187
80106fed:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106ff2:	e9 c8 f3 ff ff       	jmp    801063bf <alltraps>
...
80106ff7:	6a 00                	push   $0x0
  pushl $188
80106ff9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106ffe:	e9 bc f3 ff ff       	jmp    801063bf <alltraps>
...
80107003:	6a 00                	push   $0x0
  pushl $189
80107005:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010700a:	e9 b0 f3 ff ff       	jmp    801063bf <alltraps>
...
8010700f:	6a 00                	push   $0x0
  pushl $190
80107011:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107016:	e9 a4 f3 ff ff       	jmp    801063bf <alltraps>
...
8010701b:	6a 00                	push   $0x0
  pushl $191
8010701d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107022:	e9 98 f3 ff ff       	jmp    801063bf <alltraps>
...
80107027:	6a 00                	push   $0x0
  pushl $192
80107029:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010702e:	e9 8c f3 ff ff       	jmp    801063bf <alltraps>
...
80107033:	6a 00                	push   $0x0
  pushl $193
80107035:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010703a:	e9 80 f3 ff ff       	jmp    801063bf <alltraps>
...
8010703f:	6a 00                	push   $0x0
  pushl $194
80107041:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107046:	e9 74 f3 ff ff       	jmp    801063bf <alltraps>
...
8010704b:	6a 00                	push   $0x0
  pushl $195
8010704d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107052:	e9 68 f3 ff ff       	jmp    801063bf <alltraps>
...
80107057:	6a 00                	push   $0x0
  pushl $196
80107059:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010705e:	e9 5c f3 ff ff       	jmp    801063bf <alltraps>
...
80107063:	6a 00                	push   $0x0
  pushl $197
80107065:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010706a:	e9 50 f3 ff ff       	jmp    801063bf <alltraps>
...
8010706f:	6a 00                	push   $0x0
  pushl $198
80107071:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107076:	e9 44 f3 ff ff       	jmp    801063bf <alltraps>
...
8010707b:	6a 00                	push   $0x0
  pushl $199
8010707d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107082:	e9 38 f3 ff ff       	jmp    801063bf <alltraps>
...
80107087:	6a 00                	push   $0x0
  pushl $200
80107089:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010708e:	e9 2c f3 ff ff       	jmp    801063bf <alltraps>
...
80107093:	6a 00                	push   $0x0
  pushl $201
80107095:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010709a:	e9 20 f3 ff ff       	jmp    801063bf <alltraps>
...
8010709f:	6a 00                	push   $0x0
  pushl $202
801070a1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801070a6:	e9 14 f3 ff ff       	jmp    801063bf <alltraps>
...
801070ab:	6a 00                	push   $0x0
  pushl $203
801070ad:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801070b2:	e9 08 f3 ff ff       	jmp    801063bf <alltraps>
...
801070b7:	6a 00                	push   $0x0
  pushl $204
801070b9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801070be:	e9 fc f2 ff ff       	jmp    801063bf <alltraps>
...
801070c3:	6a 00                	push   $0x0
  pushl $205
801070c5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801070ca:	e9 f0 f2 ff ff       	jmp    801063bf <alltraps>
...
801070cf:	6a 00                	push   $0x0
  pushl $206
801070d1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801070d6:	e9 e4 f2 ff ff       	jmp    801063bf <alltraps>
...
801070db:	6a 00                	push   $0x0
  pushl $207
801070dd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801070e2:	e9 d8 f2 ff ff       	jmp    801063bf <alltraps>
...
801070e7:	6a 00                	push   $0x0
  pushl $208
801070e9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801070ee:	e9 cc f2 ff ff       	jmp    801063bf <alltraps>
...
801070f3:	6a 00                	push   $0x0
  pushl $209
801070f5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801070fa:	e9 c0 f2 ff ff       	jmp    801063bf <alltraps>
...
801070ff:	6a 00                	push   $0x0
  pushl $210
80107101:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107106:	e9 b4 f2 ff ff       	jmp    801063bf <alltraps>
...
8010710b:	6a 00                	push   $0x0
  pushl $211
8010710d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107112:	e9 a8 f2 ff ff       	jmp    801063bf <alltraps>
...
80107117:	6a 00                	push   $0x0
  pushl $212
80107119:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010711e:	e9 9c f2 ff ff       	jmp    801063bf <alltraps>
...
80107123:	6a 00                	push   $0x0
  pushl $213
80107125:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010712a:	e9 90 f2 ff ff       	jmp    801063bf <alltraps>
...
8010712f:	6a 00                	push   $0x0
  pushl $214
80107131:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107136:	e9 84 f2 ff ff       	jmp    801063bf <alltraps>
...
8010713b:	6a 00                	push   $0x0
  pushl $215
8010713d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107142:	e9 78 f2 ff ff       	jmp    801063bf <alltraps>
...
80107147:	6a 00                	push   $0x0
  pushl $216
80107149:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010714e:	e9 6c f2 ff ff       	jmp    801063bf <alltraps>
...
80107153:	6a 00                	push   $0x0
  pushl $217
80107155:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010715a:	e9 60 f2 ff ff       	jmp    801063bf <alltraps>
...
8010715f:	6a 00                	push   $0x0
  pushl $218
80107161:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107166:	e9 54 f2 ff ff       	jmp    801063bf <alltraps>
...
8010716b:	6a 00                	push   $0x0
  pushl $219
8010716d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107172:	e9 48 f2 ff ff       	jmp    801063bf <alltraps>
...
80107177:	6a 00                	push   $0x0
  pushl $220
80107179:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010717e:	e9 3c f2 ff ff       	jmp    801063bf <alltraps>
...
80107183:	6a 00                	push   $0x0
  pushl $221
80107185:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010718a:	e9 30 f2 ff ff       	jmp    801063bf <alltraps>
...
8010718f:	6a 00                	push   $0x0
  pushl $222
80107191:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107196:	e9 24 f2 ff ff       	jmp    801063bf <alltraps>
...
8010719b:	6a 00                	push   $0x0
  pushl $223
8010719d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801071a2:	e9 18 f2 ff ff       	jmp    801063bf <alltraps>
...
801071a7:	6a 00                	push   $0x0
  pushl $224
801071a9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801071ae:	e9 0c f2 ff ff       	jmp    801063bf <alltraps>
...
801071b3:	6a 00                	push   $0x0
  pushl $225
801071b5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801071ba:	e9 00 f2 ff ff       	jmp    801063bf <alltraps>
...
801071bf:	6a 00                	push   $0x0
  pushl $226
801071c1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801071c6:	e9 f4 f1 ff ff       	jmp    801063bf <alltraps>
...
801071cb:	6a 00                	push   $0x0
  pushl $227
801071cd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801071d2:	e9 e8 f1 ff ff       	jmp    801063bf <alltraps>
...
801071d7:	6a 00                	push   $0x0
  pushl $228
801071d9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801071de:	e9 dc f1 ff ff       	jmp    801063bf <alltraps>
...
801071e3:	6a 00                	push   $0x0
  pushl $229
801071e5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801071ea:	e9 d0 f1 ff ff       	jmp    801063bf <alltraps>
...
801071ef:	6a 00                	push   $0x0
  pushl $230
801071f1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801071f6:	e9 c4 f1 ff ff       	jmp    801063bf <alltraps>
...
801071fb:	6a 00                	push   $0x0
  pushl $231
801071fd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107202:	e9 b8 f1 ff ff       	jmp    801063bf <alltraps>
...
80107207:	6a 00                	push   $0x0
  pushl $232
80107209:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010720e:	e9 ac f1 ff ff       	jmp    801063bf <alltraps>
...
80107213:	6a 00                	push   $0x0
  pushl $233
80107215:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010721a:	e9 a0 f1 ff ff       	jmp    801063bf <alltraps>
...
8010721f:	6a 00                	push   $0x0
  pushl $234
80107221:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107226:	e9 94 f1 ff ff       	jmp    801063bf <alltraps>
...
8010722b:	6a 00                	push   $0x0
  pushl $235
8010722d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107232:	e9 88 f1 ff ff       	jmp    801063bf <alltraps>
...
80107237:	6a 00                	push   $0x0
  pushl $236
80107239:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010723e:	e9 7c f1 ff ff       	jmp    801063bf <alltraps>
...
80107243:	6a 00                	push   $0x0
  pushl $237
80107245:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010724a:	e9 70 f1 ff ff       	jmp    801063bf <alltraps>
...
8010724f:	6a 00                	push   $0x0
  pushl $238
80107251:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107256:	e9 64 f1 ff ff       	jmp    801063bf <alltraps>
...
8010725b:	6a 00                	push   $0x0
  pushl $239
8010725d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107262:	e9 58 f1 ff ff       	jmp    801063bf <alltraps>
...
80107267:	6a 00                	push   $0x0
  pushl $240
80107269:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010726e:	e9 4c f1 ff ff       	jmp    801063bf <alltraps>
...
80107273:	6a 00                	push   $0x0
  pushl $241
80107275:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010727a:	e9 40 f1 ff ff       	jmp    801063bf <alltraps>
...
8010727f:	6a 00                	push   $0x0
  pushl $242
80107281:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107286:	e9 34 f1 ff ff       	jmp    801063bf <alltraps>
...
8010728b:	6a 00                	push   $0x0
  pushl $243
8010728d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107292:	e9 28 f1 ff ff       	jmp    801063bf <alltraps>
...
80107297:	6a 00                	push   $0x0
  pushl $244
80107299:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010729e:	e9 1c f1 ff ff       	jmp    801063bf <alltraps>
...
801072a3:	6a 00                	push   $0x0
  pushl $245
801072a5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801072aa:	e9 10 f1 ff ff       	jmp    801063bf <alltraps>
...
801072af:	6a 00                	push   $0x0
  pushl $246
801072b1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801072b6:	e9 04 f1 ff ff       	jmp    801063bf <alltraps>
...
801072bb:	6a 00                	push   $0x0
  pushl $247
801072bd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801072c2:	e9 f8 f0 ff ff       	jmp    801063bf <alltraps>
...
801072c7:	6a 00                	push   $0x0
  pushl $248
801072c9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801072ce:	e9 ec f0 ff ff       	jmp    801063bf <alltraps>
...
801072d3:	6a 00                	push   $0x0
  pushl $249
801072d5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801072da:	e9 e0 f0 ff ff       	jmp    801063bf <alltraps>
...
801072df:	6a 00                	push   $0x0
  pushl $250
801072e1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801072e6:	e9 d4 f0 ff ff       	jmp    801063bf <alltraps>
...
801072eb:	6a 00                	push   $0x0
  pushl $251
801072ed:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801072f2:	e9 c8 f0 ff ff       	jmp    801063bf <alltraps>
...
801072f7:	6a 00                	push   $0x0
  pushl $252
801072f9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801072fe:	e9 bc f0 ff ff       	jmp    801063bf <alltraps>
...
80107303:	6a 00                	push   $0x0
  pushl $253
80107305:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010730a:	e9 b0 f0 ff ff       	jmp    801063bf <alltraps>
...
8010730f:	6a 00                	push   $0x0
  pushl $254
80107311:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107316:	e9 a4 f0 ff ff       	jmp    801063bf <alltraps>
...
8010731b:	6a 00                	push   $0x0
  pushl $255
8010731d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107322:	e9 98 f0 ff ff       	jmp    801063bf <alltraps>
80107327:	66 90                	xchg   %ax,%ax
80107329:	66 90                	xchg   %ax,%ax
8010732b:	66 90                	xchg   %ax,%ax
8010732d:	66 90                	xchg   %ax,%ax
8010732f:	90                   	nop
...
80107335:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
80107336:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
8010733c:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80107342:	83 ec 1c             	sub    $0x1c,%esp
80107345:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107348:	39 d3                	cmp    %edx,%ebx
8010734a:	73 49                	jae    80107395 <deallocuvm.part.0+0x65>
8010734c:	89 c7                	mov    %eax,%edi
8010734e:	eb 0c                	jmp    8010735c <deallocuvm.part.0+0x2c>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80107350:	83 c0 01             	add    $0x1,%eax
80107353:	c1 e0 16             	shl    $0x16,%eax
80107356:	89 c3                	mov    %eax,%ebx
  for(; a  < oldsz; a += PGSIZE){
80107358:	39 da                	cmp    %ebx,%edx
8010735a:	76 39                	jbe    80107395 <deallocuvm.part.0+0x65>
  pde = &pgdir[PDX(va)];
8010735c:	89 d8                	mov    %ebx,%eax
8010735e:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80107361:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
80107364:	f6 c1 01             	test   $0x1,%cl
80107367:	74 e7                	je     80107350 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
80107369:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010736b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80107371:	c1 ee 0a             	shr    $0xa,%esi
80107374:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
8010737a:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
    if(!pte)
80107381:	85 f6                	test   %esi,%esi
80107383:	74 cb                	je     80107350 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
80107385:	8b 06                	mov    (%esi),%eax
80107387:	a8 01                	test   $0x1,%al
80107389:	75 15                	jne    801073a0 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
8010738b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107391:	39 da                	cmp    %ebx,%edx
80107393:	77 c7                	ja     8010735c <deallocuvm.part.0+0x2c>
      kfree(v);
      *pte = 0;
    }
  }
...
80107395:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
8010739f:	c3                   	ret    
      if(pa == 0)
801073a0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801073a5:	74 25                	je     801073cc <deallocuvm.part.0+0x9c>
      kfree(v);
...
801073af:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801073b2:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
801073b8:	50                   	push   %eax
801073b9:	e8 62 b1 ff ff       	call   80102520 <kfree>
      *pte = 0;
801073be:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  for(; a  < oldsz; a += PGSIZE){
801073c4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801073c7:	83 c4 10             	add    $0x10,%esp
801073ca:	eb 8c                	jmp    80107358 <deallocuvm.part.0+0x28>
        panic("kfree");
801073cc:	83 ec 0c             	sub    $0xc,%esp
801073cf:	68 8e 7f 10 80       	push   $0x80107f8e
801073d4:	e8 a7 8f ff ff       	call   80100380 <panic>
...
801073fd:	89 45 dc             	mov    %eax,-0x24(%ebp)
80107400:	8b 45 08             	mov    0x8(%ebp),%eax
80107403:	29 d8                	sub    %ebx,%eax
80107405:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107408:	eb 3d                	jmp    80107447 <mappages+0x67>
...
80107429:	74 75                	je     801074a0 <mappages+0xc0>
    if(*pte & PTE_P)
8010742b:	f6 00 01             	testb  $0x1,(%eax)
8010742e:	0f 85 86 00 00 00    	jne    801074ba <mappages+0xda>
    *pte = pa | perm | PTE_P;
80107434:	0b 75 0c             	or     0xc(%ebp),%esi
80107437:	83 ce 01             	or     $0x1,%esi
8010743a:	89 30                	mov    %esi,(%eax)
    if(a == last)
8010743c:	3b 5d dc             	cmp    -0x24(%ebp),%ebx
8010743f:	74 6f                	je     801074b0 <mappages+0xd0>
    a += PGSIZE;
80107441:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80107447:	8b 45 e0             	mov    -0x20(%ebp),%eax
  pde = &pgdir[PDX(va)];
8010744a:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010744d:	8d 34 18             	lea    (%eax,%ebx,1),%esi
80107450:	89 d8                	mov    %ebx,%eax
80107452:	c1 e8 16             	shr    $0x16,%eax
80107455:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
80107458:	8b 07                	mov    (%edi),%eax
8010745a:	a8 01                	test   $0x1,%al
8010745c:	75 b2                	jne    80107410 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
8010745e:	e8 7d b2 ff ff       	call   801026e0 <kalloc>
80107463:	85 c0                	test   %eax,%eax
80107465:	74 39                	je     801074a0 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80107467:	83 ec 04             	sub    $0x4,%esp
8010746a:	89 45 d8             	mov    %eax,-0x28(%ebp)
8010746d:	68 00 10 00 00       	push   $0x1000
80107472:	6a 00                	push   $0x0
80107474:	50                   	push   %eax
80107475:	e8 56 dd ff ff       	call   801051d0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010747a:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
8010747d:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80107480:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80107486:	83 c8 07             	or     $0x7,%eax
80107489:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
8010748b:	89 d8                	mov    %ebx,%eax
8010748d:	c1 e8 0a             	shr    $0xa,%eax
80107490:	25 fc 0f 00 00       	and    $0xffc,%eax
80107495:	01 d0                	add    %edx,%eax
80107497:	eb 92                	jmp    8010742b <mappages+0x4b>
...
801074bd:	68 d0 87 10 80       	push   $0x801087d0
801074c2:	e8 b9 8e ff ff       	call   80100380 <panic>
...
801074d3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801074d6:	e8 65 c5 ff ff       	call   80103a40 <cpuid>
  pd[0] = size-1;
801074db:	ba 2f 00 00 00       	mov    $0x2f,%edx
801074e0:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
801074e6:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801074ea:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
801074f1:	ff 00 00 
801074f4:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
801074fb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801074fe:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
80107505:	ff 00 00 
80107508:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
8010750f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107512:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
80107519:	ff 00 00 
8010751c:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
80107523:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107526:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
8010752d:	ff 00 00 
80107530:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
80107537:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
8010753a:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
8010753f:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80107543:	c1 e8 10             	shr    $0x10,%eax
80107546:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
8010754a:	8d 45 f2             	lea    -0xe(%ebp),%eax
8010754d:	0f 01 10             	lgdtl  (%eax)
}
80107550:	c9                   	leave  
80107551:	c3                   	ret    
...
80107560:	a1 e4 63 11 80       	mov    0x801163e4,%eax
80107565:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
8010757e:	0f 84 cb 00 00 00    	je     8010764f <switchuvm+0xdf>
  if(p->kstack == 0)
80107584:	8b 46 08             	mov    0x8(%esi),%eax
80107587:	85 c0                	test   %eax,%eax
80107589:	0f 84 da 00 00 00    	je     80107669 <switchuvm+0xf9>
  if(p->pgdir == 0)
8010758f:	8b 46 04             	mov    0x4(%esi),%eax
80107592:	85 c0                	test   %eax,%eax
80107594:	0f 84 c2 00 00 00    	je     8010765c <switchuvm+0xec>
  pushcli();
8010759a:	e8 21 da ff ff       	call   80104fc0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010759f:	e8 3c c4 ff ff       	call   801039e0 <mycpu>
801075a4:	89 c3                	mov    %eax,%ebx
801075a6:	e8 35 c4 ff ff       	call   801039e0 <mycpu>
801075ab:	89 c7                	mov    %eax,%edi
801075ad:	e8 2e c4 ff ff       	call   801039e0 <mycpu>
801075b2:	83 c7 08             	add    $0x8,%edi
801075b5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801075b8:	e8 23 c4 ff ff       	call   801039e0 <mycpu>
801075bd:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801075c0:	ba 67 00 00 00       	mov    $0x67,%edx
801075c5:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
801075cc:	83 c0 08             	add    $0x8,%eax
801075cf:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801075d6:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801075db:	83 c1 08             	add    $0x8,%ecx
801075de:	c1 e8 18             	shr    $0x18,%eax
801075e1:	c1 e9 10             	shr    $0x10,%ecx
801075e4:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
801075ea:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
801075f0:	b9 99 40 00 00       	mov    $0x4099,%ecx
801075f5:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801075fc:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80107601:	e8 da c3 ff ff       	call   801039e0 <mycpu>
80107606:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010760d:	e8 ce c3 ff ff       	call   801039e0 <mycpu>
80107612:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107616:	8b 5e 08             	mov    0x8(%esi),%ebx
80107619:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010761f:	e8 bc c3 ff ff       	call   801039e0 <mycpu>
80107624:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107627:	e8 b4 c3 ff ff       	call   801039e0 <mycpu>
8010762c:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80107630:	b8 28 00 00 00       	mov    $0x28,%eax
80107635:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80107638:	8b 46 04             	mov    0x4(%esi),%eax
8010763b:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80107640:	0f 22 d8             	mov    %eax,%cr3
}
...
80107649:	5d                   	pop    %ebp
  popcli();
8010764a:	e9 c1 d9 ff ff       	jmp    80105010 <popcli>
    panic("switchuvm: no process");
8010764f:	83 ec 0c             	sub    $0xc,%esp
80107652:	68 d6 87 10 80       	push   $0x801087d6
80107657:	e8 24 8d ff ff       	call   80100380 <panic>
    panic("switchuvm: no pgdir");
8010765c:	83 ec 0c             	sub    $0xc,%esp
8010765f:	68 01 88 10 80       	push   $0x80108801
80107664:	e8 17 8d ff ff       	call   80100380 <panic>
    panic("switchuvm: no kstack");
80107669:	83 ec 0c             	sub    $0xc,%esp
8010766c:	68 ec 87 10 80       	push   $0x801087ec
...
8010768c:	8b 75 10             	mov    0x10(%ebp),%esi
8010768f:	8b 7d 08             	mov    0x8(%ebp),%edi
80107692:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80107695:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
8010769b:	77 4b                	ja     801076e8 <inituvm+0x68>
  mem = kalloc();
8010769d:	e8 3e b0 ff ff       	call   801026e0 <kalloc>
  memset(mem, 0, PGSIZE);
801076a2:	83 ec 04             	sub    $0x4,%esp
801076a5:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
801076aa:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801076ac:	6a 00                	push   $0x0
801076ae:	50                   	push   %eax
801076af:	e8 1c db ff ff       	call   801051d0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
801076b4:	58                   	pop    %eax
801076b5:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801076bb:	5a                   	pop    %edx
801076bc:	6a 06                	push   $0x6
801076be:	b9 00 10 00 00       	mov    $0x1000,%ecx
801076c3:	31 d2                	xor    %edx,%edx
801076c5:	50                   	push   %eax
801076c6:	89 f8                	mov    %edi,%eax
801076c8:	e8 13 fd ff ff       	call   801073e0 <mappages>
  memmove(mem, init, sz);
801076cd:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801076d0:	89 75 10             	mov    %esi,0x10(%ebp)
801076d3:	83 c4 10             	add    $0x10,%esp
801076d6:	89 5d 08             	mov    %ebx,0x8(%ebp)
801076d9:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
801076e2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801076e3:	e9 88 db ff ff       	jmp    80105270 <memmove>
    panic("inituvm: more than a page");
801076e8:	83 ec 0c             	sub    $0xc,%esp
801076eb:	68 15 88 10 80       	push   $0x80108815
801076f0:	e8 8b 8c ff ff       	call   80100380 <panic>
...
8010770c:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
8010770f:	a9 ff 0f 00 00       	test   $0xfff,%eax
80107714:	0f 85 bb 00 00 00    	jne    801077d5 <loaduvm+0xd5>
  for(i = 0; i < sz; i += PGSIZE){
8010771a:	01 f0                	add    %esi,%eax
8010771c:	89 f3                	mov    %esi,%ebx
8010771e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107721:	8b 45 14             	mov    0x14(%ebp),%eax
80107724:	01 f0                	add    %esi,%eax
80107726:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80107729:	85 f6                	test   %esi,%esi
8010772b:	0f 84 87 00 00 00    	je     801077b8 <loaduvm+0xb8>
80107731:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
80107738:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  if(*pde & PTE_P){
8010773b:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010773e:	29 d8                	sub    %ebx,%eax
  pde = &pgdir[PDX(va)];
80107740:	89 c2                	mov    %eax,%edx
80107742:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80107745:	8b 14 91             	mov    (%ecx,%edx,4),%edx
80107748:	f6 c2 01             	test   $0x1,%dl
8010774b:	75 13                	jne    80107760 <loaduvm+0x60>
      panic("loaduvm: address should exist");
8010774d:	83 ec 0c             	sub    $0xc,%esp
80107750:	68 2f 88 10 80       	push   $0x8010882f
80107755:	e8 26 8c ff ff       	call   80100380 <panic>
...
80107777:	74 d4                	je     8010774d <loaduvm+0x4d>
    pa = PTE_ADDR(*pte);
80107779:	8b 00                	mov    (%eax),%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
8010777b:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    if(sz - i < PGSIZE)
8010777e:	bf 00 10 00 00       	mov    $0x1000,%edi
    pa = PTE_ADDR(*pte);
80107783:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80107788:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
8010778e:	0f 46 fb             	cmovbe %ebx,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107791:	29 d9                	sub    %ebx,%ecx
80107793:	05 00 00 00 80       	add    $0x80000000,%eax
80107798:	57                   	push   %edi
80107799:	51                   	push   %ecx
8010779a:	50                   	push   %eax
8010779b:	ff 75 10             	push   0x10(%ebp)
8010779e:	e8 4d a3 ff ff       	call   80101af0 <readi>
801077a3:	83 c4 10             	add    $0x10,%esp
801077a6:	39 f8                	cmp    %edi,%eax
801077a8:	75 1e                	jne    801077c8 <loaduvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
801077aa:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
801077b0:	89 f0                	mov    %esi,%eax
801077b2:	29 d8                	sub    %ebx,%eax
801077b4:	39 c6                	cmp    %eax,%esi
801077b6:	77 80                	ja     80107738 <loaduvm+0x38>
}
...
801077d8:	68 d0 88 10 80       	push   $0x801088d0
801077dd:	e8 9e 8b ff ff       	call   80100380 <panic>
...
{
801077fc:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
801077ff:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107802:	85 c0                	test   %eax,%eax
80107804:	0f 88 b6 00 00 00    	js     801078c0 <allocuvm+0xd0>
  if(newsz < oldsz)
8010780a:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
8010780d:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80107810:	0f 82 9a 00 00 00    	jb     801078b0 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80107816:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
8010781c:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80107822:	39 75 10             	cmp    %esi,0x10(%ebp)
80107825:	77 44                	ja     8010786b <allocuvm+0x7b>
80107827:	e9 87 00 00 00       	jmp    801078b3 <allocuvm+0xc3>
...
8010783b:	e8 90 d9 ff ff       	call   801051d0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80107840:	58                   	pop    %eax
80107841:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80107847:	5a                   	pop    %edx
80107848:	6a 06                	push   $0x6
8010784a:	b9 00 10 00 00       	mov    $0x1000,%ecx
8010784f:	89 f2                	mov    %esi,%edx
80107851:	50                   	push   %eax
80107852:	89 f8                	mov    %edi,%eax
80107854:	e8 87 fb ff ff       	call   801073e0 <mappages>
80107859:	83 c4 10             	add    $0x10,%esp
8010785c:	85 c0                	test   %eax,%eax
8010785e:	78 78                	js     801078d8 <allocuvm+0xe8>
  for(; a < newsz; a += PGSIZE){
80107860:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107866:	39 75 10             	cmp    %esi,0x10(%ebp)
80107869:	76 48                	jbe    801078b3 <allocuvm+0xc3>
    mem = kalloc();
8010786b:	e8 70 ae ff ff       	call   801026e0 <kalloc>
80107870:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80107872:	85 c0                	test   %eax,%eax
80107874:	75 ba                	jne    80107830 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80107876:	83 ec 0c             	sub    $0xc,%esp
80107879:	68 4d 88 10 80       	push   $0x8010884d
8010787e:	e8 1d 8e ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
80107883:	8b 45 0c             	mov    0xc(%ebp),%eax
80107886:	83 c4 10             	add    $0x10,%esp
80107889:	39 45 10             	cmp    %eax,0x10(%ebp)
8010788c:	74 32                	je     801078c0 <allocuvm+0xd0>
8010788e:	8b 55 10             	mov    0x10(%ebp),%edx
80107891:	89 c1                	mov    %eax,%ecx
80107893:	89 f8                	mov    %edi,%eax
80107895:	e8 96 fa ff ff       	call   80107330 <deallocuvm.part.0>
      return 0;
8010789a:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
801078a1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
801078be:	66 90                	xchg   %ax,%ax
    return 0;
801078c0:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
801078c7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801078ca:	8d 65 f4             	lea    -0xc(%ebp),%esp
801078cd:	5b                   	pop    %ebx
801078ce:	5e                   	pop    %esi
801078cf:	5f                   	pop    %edi
801078d0:	5d                   	pop    %ebp
...
801078db:	68 65 88 10 80       	push   $0x80108865
801078e0:	e8 bb 8d ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
801078e5:	8b 45 0c             	mov    0xc(%ebp),%eax
801078e8:	83 c4 10             	add    $0x10,%esp
801078eb:	39 45 10             	cmp    %eax,0x10(%ebp)
801078ee:	74 0c                	je     801078fc <allocuvm+0x10c>
801078f0:	8b 55 10             	mov    0x10(%ebp),%edx
801078f3:	89 c1                	mov    %eax,%ecx
801078f5:	89 f8                	mov    %edi,%eax
801078f7:	e8 34 fa ff ff       	call   80107330 <deallocuvm.part.0>
      kfree(mem);
801078fc:	83 ec 0c             	sub    $0xc,%esp
801078ff:	53                   	push   %ebx
80107900:	e8 1b ac ff ff       	call   80102520 <kfree>
      return 0;
80107905:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
8010790c:	83 c4 10             	add    $0x10,%esp
}
8010790f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107912:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107915:	5b                   	pop    %ebx
80107916:	5e                   	pop    %esi
80107917:	5f                   	pop    %edi
80107918:	5d                   	pop    %ebp
...
80107923:	8b 55 0c             	mov    0xc(%ebp),%edx
80107926:	8b 4d 10             	mov    0x10(%ebp),%ecx
80107929:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
8010792c:	39 d1                	cmp    %edx,%ecx
8010792e:	73 10                	jae    80107940 <deallocuvm+0x20>
}
80107930:	5d                   	pop    %ebp
80107931:	e9 fa f9 ff ff       	jmp    80107330 <deallocuvm.part.0>
80107936:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010793d:	8d 76 00             	lea    0x0(%esi),%esi
80107940:	89 d0                	mov    %edx,%eax
80107942:	5d                   	pop    %ebp
80107943:	c3                   	ret    
...
80107959:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
8010795c:	85 f6                	test   %esi,%esi
8010795e:	74 59                	je     801079b9 <freevm+0x69>
  if(newsz >= oldsz)
80107960:	31 c9                	xor    %ecx,%ecx
80107962:	ba 00 00 00 80       	mov    $0x80000000,%edx
80107967:	89 f0                	mov    %esi,%eax
80107969:	89 f3                	mov    %esi,%ebx
8010796b:	e8 c0 f9 ff ff       	call   80107330 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80107970:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80107976:	eb 0f                	jmp    80107987 <freevm+0x37>
80107978:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010797f:	90                   	nop
80107980:	83 c3 04             	add    $0x4,%ebx
80107983:	39 df                	cmp    %ebx,%edi
80107985:	74 23                	je     801079aa <freevm+0x5a>
    if(pgdir[i] & PTE_P){
80107987:	8b 03                	mov    (%ebx),%eax
80107989:	a8 01                	test   $0x1,%al
8010798b:	74 f3                	je     80107980 <freevm+0x30>
      char * v = P2V(PTE_ADDR(pgdir[i]));
8010798d:	25 00 f0 ff ff       	and    $0xfffff000,%eax
      kfree(v);
80107992:	83 ec 0c             	sub    $0xc,%esp
  for(i = 0; i < NPDENTRIES; i++){
80107995:	83 c3 04             	add    $0x4,%ebx
      char * v = P2V(PTE_ADDR(pgdir[i]));
80107998:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
8010799d:	50                   	push   %eax
8010799e:	e8 7d ab ff ff       	call   80102520 <kfree>
801079a3:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NPDENTRIES; i++){
801079a6:	39 df                	cmp    %ebx,%edi
801079a8:	75 dd                	jne    80107987 <freevm+0x37>
    }
  }
  kfree((char*)pgdir);
801079aa:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
801079b3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801079b4:	e9 67 ab ff ff       	jmp    80102520 <kfree>
    panic("freevm: no pgdir");
801079b9:	83 ec 0c             	sub    $0xc,%esp
801079bc:	68 81 88 10 80       	push   $0x80108881
801079c1:	e8 ba 89 ff ff       	call   80100380 <panic>
...
801079d5:	e8 06 ad ff ff       	call   801026e0 <kalloc>
801079da:	89 c6                	mov    %eax,%esi
801079dc:	85 c0                	test   %eax,%eax
801079de:	74 42                	je     80107a22 <setupkvm+0x52>
  memset(pgdir, 0, PGSIZE);
801079e0:	83 ec 04             	sub    $0x4,%esp
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801079e3:	bb 20 b4 10 80       	mov    $0x8010b420,%ebx
  memset(pgdir, 0, PGSIZE);
801079e8:	68 00 10 00 00       	push   $0x1000
801079ed:	6a 00                	push   $0x0
801079ef:	50                   	push   %eax
801079f0:	e8 db d7 ff ff       	call   801051d0 <memset>
801079f5:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
801079f8:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
801079fb:	83 ec 08             	sub    $0x8,%esp
801079fe:	8b 4b 08             	mov    0x8(%ebx),%ecx
80107a01:	ff 73 0c             	push   0xc(%ebx)
80107a04:	8b 13                	mov    (%ebx),%edx
80107a06:	50                   	push   %eax
80107a07:	29 c1                	sub    %eax,%ecx
80107a09:	89 f0                	mov    %esi,%eax
80107a0b:	e8 d0 f9 ff ff       	call   801073e0 <mappages>
80107a10:	83 c4 10             	add    $0x10,%esp
80107a13:	85 c0                	test   %eax,%eax
80107a15:	78 19                	js     80107a30 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107a17:	83 c3 10             	add    $0x10,%ebx
80107a1a:	81 fb 60 b4 10 80    	cmp    $0x8010b460,%ebx
80107a20:	75 d6                	jne    801079f8 <setupkvm+0x28>
}
80107a22:	8d 65 f8             	lea    -0x8(%ebp),%esp
80107a25:	89 f0                	mov    %esi,%eax
80107a27:	5b                   	pop    %ebx
80107a28:	5e                   	pop    %esi
80107a29:	5d                   	pop    %ebp
80107a2a:	c3                   	ret    
...
80107a34:	31 f6                	xor    %esi,%esi
      freevm(pgdir);
80107a36:	e8 15 ff ff ff       	call   80107950 <freevm>
      return 0;
80107a3b:	83 c4 10             	add    $0x10,%esp
}
80107a3e:	8d 65 f8             	lea    -0x8(%ebp),%esp
80107a41:	89 f0                	mov    %esi,%eax
80107a43:	5b                   	pop    %ebx
80107a44:	5e                   	pop    %esi
80107a45:	5d                   	pop    %ebp
80107a46:	c3                   	ret    
...
80107a53:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107a56:	e8 75 ff ff ff       	call   801079d0 <setupkvm>
80107a5b:	a3 e4 63 11 80       	mov    %eax,0x801163e4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80107a60:	05 00 00 00 80       	add    $0x80000000,%eax
80107a65:	0f 22 d8             	mov    %eax,%cr3
}
80107a68:	c9                   	leave  
80107a69:	c3                   	ret    
...
80107a76:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80107a79:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
80107a7c:	89 c1                	mov    %eax,%ecx
80107a7e:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80107a81:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
80107a84:	f6 c2 01             	test   $0x1,%dl
80107a87:	75 17                	jne    80107aa0 <clearpteu+0x30>
  pte_t *pte;
...
80107a8c:	68 92 88 10 80       	push   $0x80108892
...
80107a9d:	8d 76 00             	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80107aa0:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107aa3:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80107aa9:	25 fc 0f 00 00       	and    $0xffc,%eax
80107aae:	8d 84 02 00 00 00 80 	lea    -0x80000000(%edx,%eax,1),%eax
  if(pte == 0)
80107ab5:	85 c0                	test   %eax,%eax
80107ab7:	74 d0                	je     80107a89 <clearpteu+0x19>
  *pte &= ~PTE_U;
80107ab9:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
80107abc:	c9                   	leave  
80107abd:	c3                   	ret    
...
80107ac6:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80107ac9:	e8 02 ff ff ff       	call   801079d0 <setupkvm>
80107ace:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107ad1:	85 c0                	test   %eax,%eax
80107ad3:	0f 84 bd 00 00 00    	je     80107b96 <copyuvm+0xd6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107ad9:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80107adc:	85 c9                	test   %ecx,%ecx
80107ade:	0f 84 b2 00 00 00    	je     80107b96 <copyuvm+0xd6>
80107ae4:	31 f6                	xor    %esi,%esi
80107ae6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107aed:	8d 76 00             	lea    0x0(%esi),%esi
  if(*pde & PTE_P){
80107af0:	8b 4d 08             	mov    0x8(%ebp),%ecx
  pde = &pgdir[PDX(va)];
80107af3:	89 f0                	mov    %esi,%eax
80107af5:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80107af8:	8b 04 81             	mov    (%ecx,%eax,4),%eax
80107afb:	a8 01                	test   $0x1,%al
80107afd:	75 11                	jne    80107b10 <copyuvm+0x50>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80107aff:	83 ec 0c             	sub    $0xc,%esp
80107b02:	68 9c 88 10 80       	push   $0x8010889c
80107b07:	e8 74 88 ff ff       	call   80100380 <panic>
80107b0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  return &pgtab[PTX(va)];
80107b10:	89 f2                	mov    %esi,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107b12:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80107b17:	c1 ea 0a             	shr    $0xa,%edx
80107b1a:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80107b20:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80107b27:	85 c0                	test   %eax,%eax
80107b29:	74 d4                	je     80107aff <copyuvm+0x3f>
    if(!(*pte & PTE_P))
80107b2b:	8b 00                	mov    (%eax),%eax
80107b2d:	a8 01                	test   $0x1,%al
80107b2f:	0f 84 9f 00 00 00    	je     80107bd4 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80107b35:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
80107b37:	25 ff 0f 00 00       	and    $0xfff,%eax
80107b3c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80107b3f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107b45:	e8 96 ab ff ff       	call   801026e0 <kalloc>
80107b4a:	89 c3                	mov    %eax,%ebx
80107b4c:	85 c0                	test   %eax,%eax
80107b4e:	74 64                	je     80107bb4 <copyuvm+0xf4>
      goto bad;
...
80107b60:	e8 0b d7 ff ff       	call   80105270 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80107b65:	58                   	pop    %eax
80107b66:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80107b6c:	5a                   	pop    %edx
80107b6d:	ff 75 e4             	push   -0x1c(%ebp)
80107b70:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107b75:	89 f2                	mov    %esi,%edx
80107b77:	50                   	push   %eax
80107b78:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107b7b:	e8 60 f8 ff ff       	call   801073e0 <mappages>
80107b80:	83 c4 10             	add    $0x10,%esp
80107b83:	85 c0                	test   %eax,%eax
80107b85:	78 21                	js     80107ba8 <copyuvm+0xe8>
  for(i = 0; i < sz; i += PGSIZE){
80107b87:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107b8d:	39 75 0c             	cmp    %esi,0xc(%ebp)
80107b90:	0f 87 5a ff ff ff    	ja     80107af0 <copyuvm+0x30>
  return d;
...
80107b96:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107b99:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107b9c:	5b                   	pop    %ebx
80107b9d:	5e                   	pop    %esi
80107b9e:	5f                   	pop    %edi
80107b9f:	5d                   	pop    %ebp
...
80107bab:	53                   	push   %ebx
80107bac:	e8 6f a9 ff ff       	call   80102520 <kfree>
      goto bad;
80107bb1:	83 c4 10             	add    $0x10,%esp
  freevm(d);
80107bb4:	83 ec 0c             	sub    $0xc,%esp
80107bb7:	ff 75 e0             	push   -0x20(%ebp)
80107bba:	e8 91 fd ff ff       	call   80107950 <freevm>
  return 0;
80107bbf:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
80107bc6:	83 c4 10             	add    $0x10,%esp
}
80107bc9:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107bcc:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107bcf:	5b                   	pop    %ebx
80107bd0:	5e                   	pop    %esi
80107bd1:	5f                   	pop    %edi
80107bd2:	5d                   	pop    %ebp
...
80107bd7:	68 b6 88 10 80       	push   $0x801088b6
80107bdc:	e8 9f 87 ff ff       	call   80100380 <panic>
80107be1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107be8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107bef:	90                   	nop
...
80107bf3:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80107bf6:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
80107bf9:	89 c1                	mov    %eax,%ecx
80107bfb:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80107bfe:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
80107c01:	f6 c2 01             	test   $0x1,%dl
80107c04:	0f 84 00 01 00 00    	je     80107d0a <uva2ka.cold>
  return &pgtab[PTX(va)];
80107c0a:	c1 e8 0c             	shr    $0xc,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107c0d:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  if((*pte & PTE_P) == 0)
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
80107c13:	5d                   	pop    %ebp
  return &pgtab[PTX(va)];
80107c14:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
80107c19:	8b 84 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%eax
  if((*pte & PTE_U) == 0)
...
80107c27:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107c2a:	05 00 00 00 80       	add    $0x80000000,%eax
80107c2f:	83 fa 05             	cmp    $0x5,%edx
80107c32:	ba 00 00 00 00       	mov    $0x0,%edx
80107c37:	0f 45 c2             	cmovne %edx,%eax
}
80107c3a:	c3                   	ret    
...
80107c4f:	8b 55 10             	mov    0x10(%ebp),%edx
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80107c52:	85 f6                	test   %esi,%esi
80107c54:	75 51                	jne    80107ca7 <copyout+0x67>
80107c56:	e9 a5 00 00 00       	jmp    80107d00 <copyout+0xc0>
80107c5b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107c5f:	90                   	nop
  return (char*)P2V(PTE_ADDR(*pte));
80107c60:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80107c66:	8d 8b 00 00 00 80    	lea    -0x80000000(%ebx),%ecx
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
80107c6c:	81 fb 00 00 00 80    	cmp    $0x80000000,%ebx
80107c72:	74 75                	je     80107ce9 <copyout+0xa9>
      return -1;
    n = PGSIZE - (va - va0);
80107c74:	89 fb                	mov    %edi,%ebx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80107c76:	89 55 10             	mov    %edx,0x10(%ebp)
    n = PGSIZE - (va - va0);
80107c79:	29 c3                	sub    %eax,%ebx
80107c7b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107c81:	39 f3                	cmp    %esi,%ebx
80107c83:	0f 47 de             	cmova  %esi,%ebx
    memmove(pa0 + (va - va0), buf, n);
80107c86:	29 f8                	sub    %edi,%eax
80107c88:	83 ec 04             	sub    $0x4,%esp
80107c8b:	01 c1                	add    %eax,%ecx
80107c8d:	53                   	push   %ebx
80107c8e:	52                   	push   %edx
80107c8f:	51                   	push   %ecx
80107c90:	e8 db d5 ff ff       	call   80105270 <memmove>
    len -= n;
    buf += n;
80107c95:	8b 55 10             	mov    0x10(%ebp),%edx
    va = va0 + PGSIZE;
80107c98:	8d 87 00 10 00 00    	lea    0x1000(%edi),%eax
  while(len > 0){
80107c9e:	83 c4 10             	add    $0x10,%esp
    buf += n;
80107ca1:	01 da                	add    %ebx,%edx
  while(len > 0){
80107ca3:	29 de                	sub    %ebx,%esi
80107ca5:	74 59                	je     80107d00 <copyout+0xc0>
  if(*pde & PTE_P){
80107ca7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pde = &pgdir[PDX(va)];
80107caa:	89 c1                	mov    %eax,%ecx
    va0 = (uint)PGROUNDDOWN(va);
80107cac:	89 c7                	mov    %eax,%edi
  pde = &pgdir[PDX(va)];
80107cae:	c1 e9 16             	shr    $0x16,%ecx
    va0 = (uint)PGROUNDDOWN(va);
80107cb1:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  if(*pde & PTE_P){
80107cb7:	8b 0c 8b             	mov    (%ebx,%ecx,4),%ecx
80107cba:	f6 c1 01             	test   $0x1,%cl
80107cbd:	0f 84 4e 00 00 00    	je     80107d11 <copyout.cold>
  return &pgtab[PTX(va)];
80107cc3:	89 fb                	mov    %edi,%ebx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107cc5:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80107ccb:	c1 eb 0c             	shr    $0xc,%ebx
80107cce:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
  if((*pte & PTE_P) == 0)
80107cd4:	8b 9c 99 00 00 00 80 	mov    -0x80000000(%ecx,%ebx,4),%ebx
  if((*pte & PTE_U) == 0)
80107cdb:	89 d9                	mov    %ebx,%ecx
80107cdd:	83 e1 05             	and    $0x5,%ecx
80107ce0:	83 f9 05             	cmp    $0x5,%ecx
80107ce3:	0f 84 77 ff ff ff    	je     80107c60 <copyout+0x20>
  }
  return 0;
}
80107ce9:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
80107cec:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80107cf1:	5b                   	pop    %ebx
80107cf2:	5e                   	pop    %esi
80107cf3:	5f                   	pop    %edi
...
80107d0a <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
80107d0a:	a1 00 00 00 00       	mov    0x0,%eax
80107d0f:	0f 0b                	ud2    

80107d11 <copyout.cold>:
80107d11:	a1 00 00 00 00       	mov    0x0,%eax
80107d16:	0f 0b                	ud2    
