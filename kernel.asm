...
80103e5d:	68 00 83 10 80       	push   $0x80108300
...
8010465b:	8b 14 85 6c 84 10 80 	mov    -0x7fef7b94(,%eax,4),%edx
      state = "???";
...
80104820:	8b 04 95 54 84 10 80 	mov    -0x7fef7bac(,%edx,4),%eax
...
80104840:	8b 04 95 48 84 10 80 	mov    -0x7fef7bb8(,%edx,4),%eax
...
80104863:	8b 04 95 3c 84 10 80 	mov    -0x7fef7bc4(,%edx,4),%eax
...
801049f4:	8b 34 85 54 84 10 80 	mov    -0x7fef7bac(,%eax,4),%esi
    cprintf("%s", stateStr);
...
80104a4c:	8b 34 85 48 84 10 80 	mov    -0x7fef7bb8(,%eax,4),%esi
    cprintf("%s", classStr);
...
80104aa4:	8b 34 85 3c 84 10 80 	mov    -0x7fef7bc4(,%eax,4),%esi
...
80104d3a:	68 84 84 10 80       	push   $0x80108484
...
80104f75:	68 8f 84 10 80       	push   $0x8010848f
80104f7a:	e8 01 b4 ff ff       	call   80100380 <panic>
    panic("popcli");
80104f7f:	83 ec 0c             	sub    $0xc,%esp
80104f82:	68 a6 84 10 80       	push   $0x801084a6
...
80104feb:	68 ad 84 10 80       	push   $0x801084ad
...
801050e0:	68 b5 84 10 80       	push   $0x801084b5
...
80105538:	68 bd 84 10 80       	push   $0x801084bd
...
80106210:	68 a0 5b 11 80       	push   $0x80115ba0
80106215:	e8 16 ee ff ff       	call   80105030 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010621a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010621d:	8b 1d 80 5b 11 80    	mov    0x80115b80,%ebx
  while(ticks - ticks0 < n){
...
80106233:	68 a0 5b 11 80       	push   $0x80115ba0
80106238:	68 80 5b 11 80       	push   $0x80115b80
8010623d:	e8 ce e1 ff ff       	call   80104410 <sleep>
  while(ticks - ticks0 < n){
80106242:	a1 80 5b 11 80       	mov    0x80115b80,%eax
...
80106260:	68 a0 5b 11 80       	push   $0x80115ba0
...
80106283:	68 a0 5b 11 80       	push   $0x80115ba0
...
801062a4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801062a7:	68 a0 5b 11 80       	push   $0x80115ba0
801062ac:	e8 7f ed ff ff       	call   80105030 <acquire>
  xticks = ticks;
801062b1:	8b 1d 80 5b 11 80    	mov    0x80115b80,%ebx
  release(&tickslock);
801062b7:	c7 04 24 a0 5b 11 80 	movl   $0x80115ba0,(%esp)
...
80106327:	c7 04 c5 e2 5b 11 80 	movl   $0x8e000008,-0x7feea41e(,%eax,8)
8010632e:	08 00 00 8e 
80106332:	66 89 14 c5 e0 5b 11 	mov    %dx,-0x7feea420(,%eax,8)
80106339:	80 
8010633a:	c1 ea 10             	shr    $0x10,%edx
8010633d:	66 89 14 c5 e6 5b 11 	mov    %dx,-0x7feea41a(,%eax,8)
80106344:	80 
  for(i = 0; i < 256; i++)
...
80106357:	c7 05 e2 5d 11 80 08 	movl   $0xef000008,0x80115de2
8010635e:	00 00 ef 
  initlock(&tickslock, "time");
80106361:	68 72 82 10 80       	push   $0x80108272
80106366:	68 a0 5b 11 80       	push   $0x80115ba0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010636b:	66 a3 e0 5d 11 80    	mov    %ax,0x80115de0
80106371:	c1 e8 10             	shr    $0x10,%eax
80106374:	66 a3 e6 5d 11 80    	mov    %ax,0x80115de6
  initlock(&tickslock, "time");
...
8010639b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010639f:	b8 e0 5b 11 80       	mov    $0x80115be0,%eax
...
801065d0:	68 a0 5b 11 80       	push   $0x80115ba0
801065d5:	e8 56 ea ff ff       	call   80105030 <acquire>
      wakeup(&ticks);
801065da:	c7 04 24 80 5b 11 80 	movl   $0x80115b80,(%esp)
      ticks++;
801065e1:	83 05 80 5b 11 80 01 	addl   $0x1,0x80115b80
      wakeup(&ticks);
801065e8:	e8 e3 de ff ff       	call   801044d0 <wakeup>
      release(&tickslock);
801065ed:	c7 04 24 a0 5b 11 80 	movl   $0x80115ba0,(%esp)
...
{
  if(!uart)
80106650:	a1 e0 63 11 80       	mov    0x801163e0,%eax
...
801066d7:	74 78                	je     80106751 <uartinit+0xd1>
  uart = 1;
801066d9:	c7 05 e0 63 11 80 01 	movl   $0x1,0x801163e0
801066e0:	00 00 00 
...
80106709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80106710:	a1 e0 63 11 80       	mov    0x801163e0,%eax
...
80106760 <uartputc>:
  if(!uart)
80106760:	a1 e0 63 11 80       	mov    0x801163e0,%eax
...
80107480:	a1 e4 63 11 80       	mov    0x801163e4,%eax
...
8010797b:	a3 e4 63 11 80       	mov    %eax,0x801163e4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
